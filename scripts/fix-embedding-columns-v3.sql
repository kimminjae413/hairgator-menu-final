-- ============================================================================
-- Supabase 임베딩 컬럼 타입 수정 스크립트 v3 (최종 수정)
...
WHERE recipe_embedding_backup IS NOT NULL
  AND recipe_embedding_backup LIKE '[%';
...
WHERE summary_embedding_backup IS NOT NULL
  AND summary_embedding_backup LIKE '[%';
