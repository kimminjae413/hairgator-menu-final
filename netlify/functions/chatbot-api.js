...
**🔥 E vs F vs G 구분 (가장 헷갈리는 부분! 목 노출 정도로 판단)**

E Length (30cm): **어깨 바로 위**
  - 머리카락 끝이 어깨선 위 2-3cm
  - **핵심 판단 기준: 목 전체가 보임** ← 중요!
  - 목과 어깨 사이에 공간 있음
  - 어깨에 닿지 않음

F Length (25cm): **턱선 바로 밑**
  - 머리카락 끝이 턱뼈 아래
  - **핵심 판단 기준: 목 상단만 보임** ← 중요!
  - 턱에서 목으로 넘어가는 지점
  - 목 중간 정도까지 머리카락
...
3. **목 노출 정도 확인** (어깨 위인 경우) ← 가장 중요!:
   - **목 전체 보임** (어깨와 턱 사이 목 전체) → **E Length**
