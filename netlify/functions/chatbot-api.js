...
### 📍 STEP 1. 리셋션 섹션 (측두부 - 구레나룻 위 영역)

**1-1. 엑스터널 (바깥쪽 아웃라인)**
- 📐 리프팅: L0 (0도 - 자연스럽게 떨어뜨린 상태)
- 🔄 디렉션: D4 (측면 기준)
- ✂️ 기법: 블런트 컷 (일자로 깔끔하게)
- 💡 포인트: 아웃라인 정리, 기장 설정

**1-2. 인터널 (안쪽 볼륨층)**
- 📐 리프팅: L8 (180도 - 머리를 완전히 세운 상태)
- 🔄 디렉션: D8 (뒤쪽으로 당겨서)
- ✂️ 기법: 고정 디자인라인 (같은 길이 유지)
- 💡 포인트: 볼륨 형성, 가벼움 추가

---

### 📍 STEP 2. 사이드 섹션 (귀 주변 영역)
...
### ⚠️ 주의사항:
1. 각 STEP은 "---" 구분선으로 명확히 분리
2. 모든 수치 뒤에 괄호() 설명 필수
3. 이모지로 항목 구분 (📐📍✂️💡🔄)
4. 불릿포인트(-)로 가독성 확보
5. 한 문장에 너무 많은 정보 넣지 않기`
            }]
          }],
          tools: [{
            fileSearch: {
