...
const HAIRGATOR_I18N = {
  ko: {
    ...
    aiStudio: {
      ...
      canvasTitle: '솔루션 캔버스',
      canvasEmpty: '💡 <b>이렇게 활용해보세요!</b><br><br><span style="color:#888">평소:</span> "복구펌 원리가 뭐야?"<br><span style="color:#4CAF50">→ 고객에게:</span> "모발 내부 결합을 채워주는 시술이에요"<br><br><span style="color:#888">평소:</span> "손상모에 어떤 샴푸?"<br><span style="color:#4CAF50">→ 고객에게:</span> "약산성 샴푸로 큐티클을 닫아주세요"<br><br><span style="color:#888">평소:</span> 고객 사진 업로드<br><span style="color:#4CAF50">→ 고객에게:</span> 맞춤 레시피로 신뢰감 있는 상담',
      backToMenu: '메뉴로 돌아가기',
      newChat: '새 채팅',
      history: '히스토리',
      deleteChat: '대화 삭제',
  ...
  en: {
    ...
    aiStudio: {
      ...
      canvasEmpty: '💡 <b>How to use this!</b><br><br><span style="color:#888">Study:</span> "What is repair perm?"<br><span style="color:#4CAF50">→ To client:</span> "It restores the bonds inside your hair"<br><br><span style="color:#888">Study:</span> "Best shampoo for damaged hair?"<br><span style="color:#4CAF50">→ To client:</span> "Use a low pH shampoo to seal the cuticle"<br><br><span style="color:#888">Study:</span> Upload client photo<br><span style="color:#4CAF50">→ To client:</span> Personalized recipe builds trust',
  ...
  ja: {
    ...
    aiStudio: {
      ...
      canvasEmpty: '💡 <b>こう活用しましょう！</b><br><br><span style="color:#888">普段:</span>「復元パーマの原理は？」<br><span style="color:#4CAF50">→ お客様に:</span>「髪内部の結合を補修する施術です」<br><br><span style="color:#888">普段:</span>「ダメージヘアにどんなシャンプー？」<br><span style="color:#4CAF50">→ お客様に:</span>「弱酸性シャンプーでキューティクルを閉じてください」<br><br><span style="color:#888">普段:</span> お客様の写真をアップロード<br><span style="color:#4CAF50">→ お客様に:</span> オーダーメイドレシピで信頼感のあるカウンセリング',
      backToMenu: 'メニューに戻る',
      newChat: '新しいチャット',
      history: '履歴',
      deleteChat: 'チャット削除',
  ...
  zh: {
    ...
    aiStudio: {
      ...
      canvasTitle: '解决方案画布',
      canvasEmpty: '💡 <b>这样活用吧！</b><br><br><span style="color:#888">平时:</span>"修复烫的原理是什么？"<br><span style="color:#4CAF50">→ 对顾客:</span>"这是修复头发内部结合的护理"<br><br><span style="color:#888">平时:</span>"受损发质用什么洗发水？"<br><span style="color:#4CAF50">→ 对顾客:</span>"用弱酸性洗发水封闭毛鳞片"<br><br><span style="color:#888">平时:</span> 上传顾客照片<br><span style="color:#4CAF50">→ 对顾客:</span> 定制配方建立信任感',
      backToMenu: '返回菜单',
      newChat: '新对话',
      history: '历史',
      deleteChat: '删除对话',
  ...
  vi: {
    ...
    aiStudio: {
      ...
      canvasEmpty: '💡 <b>Hãy sử dụng như thế này!</b><br><br><span style="color:#888">Học:</span> "Nguyên lý uốn phục hồi là gì?"<br><span style="color:#4CAF50">→ Với khách:</span> "Đây là liệu trình phục hồi liên kết bên trong tóc"<br><br><span style="color:#888">Học:</span> "Dầu gội nào cho tóc hư tổn?"<br><span style="color:#4CAF50">→ Với khách:</span> "Dùng dầu gội pH thấp để đóng lớp biểu bì"<br><br><span style="color:#888">Học:</span> Tải ảnh khách hàng<br><span style="color:#4CAF50">→ Với khách:</span> Công thức tùy chỉnh tạo sự tin tưởng',
