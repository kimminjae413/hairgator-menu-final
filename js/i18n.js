  ...
  ko: {
    ...
    personalColor: {
      ...
      aiMode: {
        ...
        description: '실시간 카메라로 AI가 피부톤을 분석합니다. 정확한 진단을 위해 화장기 없는 맨얼굴로, 자연광에서 촬영해주세요.',
  ...
  en: {
    ...
    personalColor: {
      ...
      aiMode: {
        ...
        description: 'AI analyzes your skin tone in real-time through camera. For accurate results, use a bare face without makeup in natural light.',
  ...
  ja: {
    ...
    personalColor: {
      ...
      aiMode: {
        ...
        description: 'リアルタイムカメラでAIが肌のトーンを分析します。正確な診断のため、素顔で自然光の下で撮影してください。',
  ...
  zh: {
    ...
    personalColor: {
      ...
      aiMode: {
        ...
        description: 'AI通过实时摄像头分析肤色。为确保准确诊断，请素颜并在自然光下拍摄。',
  ...
  vi: {
    ...
    personalColor: {
      ...
      aiMode: {
        ...
        description: 'AI phân tích tông da theo thời gian thực qua camera. Để có kết quả chính xác, hãy để mặt mộc dưới ánh sáng tự nhiên.',
