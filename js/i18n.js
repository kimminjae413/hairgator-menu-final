...
const HAIRGATOR_I18N = {
  ko: {
    ...
    lookbook: {
      ...
      loadingSubtext: '이미지 3장을 생성 중입니다. 잠시만 기다려주세요.',
      theEdit: 'THE EDIT',
  ...
  ja: {
    ...
    lookbook: {
      ...
      loadingSubtext: '3枚の画像を生成中です。しばらくお待ちください。',
      theEdit: 'THE EDIT',
  ...
  vi: {
    ...
    lookbook: {
      ...
      loadingSubtext: 'Đang tạo 3 hình ảnh. Vui lòng đợi.',
      theEdit: 'THE EDIT',
