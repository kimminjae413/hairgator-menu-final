...
const HAIRGATOR_I18N = {
  ...
  en: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: 'Switch to Free plan?\n\nYou can continue using your current plan until expiry.\nAfter expiry, you will be automatically switched to Free plan.\n\n⚠️ Your credits will be reset upon switching.',
      downgradeScheduled: 'Free plan switch has been scheduled.\nYou will be automatically switched after expiry.',
  ...
  ja: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: '無料プランに変更しますか？\n\n現在のプランの有効期限までは引き続きご利用いただけます。\n有効期限後、自動的に無料プランに変更されます。\n\n⚠️ 変更時にクレジットがリセットされます。',
  ...
  vi: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: 'Chuyển sang gói Miễn phí?\n\nBạn có thể tiếp tục sử dụng gói hiện tại cho đến khi hết hạn.\nSau khi hết hạn, bạn sẽ tự động chuyển sang gói Miễn phí.\n\n⚠️ Điểm tín dụng sẽ được đặt lại khi chuyển đổi.',
      downgradeScheduled: 'Đã đặt lịch chuyển sang gói Miễn phí.\nSẽ tự động chuyển đổi sau khi hết hạn.',
  ...
  id: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: 'Beralih ke paket Gratis?\n\nAnda dapat terus menggunakan paket saat ini hingga kedaluwarsa.\nSetelah kedaluwarsa, Anda akan otomatis beralih ke paket Gratis.\n\n⚠️ Kredit Anda akan direset saat beralih.',
      downgradeScheduled: 'Peralihan ke paket Gratis telah dijadwalkan.\nAnda akan otomatis beralih setelah kedaluwarsa.',
  ...
  es: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: '¿Cambiar al plan Gratis?\n\nPuede seguir usando su plan actual hasta que expire.\nDespués del vencimiento, cambiará automáticamente al plan Gratis.\n\n⚠️ Sus créditos se restablecerán al cambiar.',
      downgradeScheduled: 'El cambio al plan Gratis ha sido programado.\nCambiará automáticamente después del vencimiento.',
