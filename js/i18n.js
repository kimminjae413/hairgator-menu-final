...
const HAIRGATOR_I18N = {
  ...
  th: {
    ...
    descriptions: {
      ...
      'BUZZ': 'ผู้ชายที่ผมสั้นที่สุด's cut style, reveals head shape and contours for a simple, no-frills image with very easy maintenance',
    ...
    ui: {
      ...
      downgradeConfirmMessage: 'เปลี่ยนเป็นแผนฟรีหรือไม่? (Switch to Free plan?)

【คุณสมบัติแผนฟรี (Free Plan Features)】
• ปรึกษา AI Chatbot
• เรียกดูเมนูทรงผม (Style menu browsing)
• เข้าถึงสูตร/แผนภาพ (Recipe/diagram access)

【คุณสมบัติที่จำกัด (Limited Features)】
• สร้าง AI Lookbook
• ลองทรงผมด้วย AI (AI Hair Try-on)
• สลับใบหน้าด้วย AI (AI Face Swap)
• จับคู่สไตล์ด้วย AI (AI Style Matching)

คุณต้องการดำเนินการต่อหรือไม่ (Do you want to proceed?)',
      downgradeScheduled: '✅ กำหนดการเปลี่ยนเป็นแผนฟรีเรียบร้อยแล้ว (Free plan switch has been scheduled.)

• ใช้คุณสมบัติทั้งหมดจนกว่าแผนปัจจุบันจะหมดอายุ (Use all features until current plan expires)
• เปลี่ยนเป็นแผนฟรีโดยอัตโนมัติหลังจากหมดอายุ (Auto-switch to Free after expiry)
• เครดิตจะถูกรีเซ็ตเมื่อเปลี่ยน (Credits will be reset upon switching)
• ไม่มีการชำระเงินจากรอบการเรียกเก็บเงินถัดไป (No payment from next billing cycle)',
...
แผนปัจจุบันของคุณจะยังคงอยู่หากยกเลิก',
    ...
    // ========== AI Studio Chatbot ==========
    aiStudio: {
      welcomeTitle: 'สวัสดี! ฉัน...'m HAIRGATOR AI.',
      ...
      canvasTitle: 'Solution Canvas',
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b> คือ<br>AI ที่มีความเชี่ยวชาญในสูตรการตัด/ดัด และทฤษฎีเกี่ยวกับเส้นผม<br><br>💡 <b>วิธีใช้ให้เกิดประโยชน์สูงสุด!</b><br><br><b>1) อัปโหลดรูปภาพสไตล์</b><br>อัปโหลดสไตล์ที่คุณต้องการเรียนรู้และฝึกฝนด้วยสูตร<span style='color:#888">Ex: Upload hush cut photo → Get custom recipe</span><br><br><b>2) Ask Theory/Principles</b><br>Practice explaining treatments in Why→How→Result flow.<br><span style="color:#888">Ex: 'โคนผมแบนเนื่องจากรูปศีรษะ(ทำไม).<br>การดัดผมที่โคนผมจะเพิ่มวอลลุ่ม(อย่างไร) สร้างเงาเป็นรูปวงรี(ผลลัพธ์).'</span><br><br>Explaining with scientific reasoning to clients<br>will boost their trust in you.<br><br><span style="color:#888; font-style:italic">"The only place Success(S) comes before Work(W) is in the dictionary"<br>- Vidal Sassoon</span>',
...
คุณต้องการดำเนินการต่อหรือไม่?',
      ...
      descriptions: {
        main: 'เปิดรับความวุ่นวาย สไตล์นี้จะนำจิตวิญญาณแห่งความอิสระและโบฮีเมียนมาสู่การจัดแต่งทรงผมที่ทันสมัย's not just a hairstyle; it\'s an attitude.',
        faceShape: '**วอลลุ่มด้านข้างที่เยอะ (rich side volume)** ของสไตล์นี้ช่วยเสริมโครงหน้าเรียวของใบหน้ารูปหัวใจ สร้างความสมดุล พร้อมทั้งเพิ่มข้อดีของใบหน้ารูปไข่โดยเน้นรูปทรงที่อ่อนโยน',
        maintenance: 'ความงามของสไตล์นี้อยู่ที่ **การดูแลรักษาที่ง่าย (low maintenance)** ยิ่งยุ่งเหยิงยิ่งดี อย่างไรก็ตาม ความชุ่มชื้นเป็นสิ่งสำคัญในการป้องกัน'straw-like\' appearance.'
      },
      styleVariations: {
...
กล้องสามารถใช้งานได้เฉพาะในสภาพแวดล้อม HTTPS เท่านั้น',
      ...
      seasonRecommendations: {
        springWarmBright: '💄 สี: Vivid Coral (สีส้มปะการังสดใส), Orange Red (สีส้มแดง), Bright Peach (สีพีชสว่าง)
💎 โลหะ: Yellow Gold (ทองคำ), Bright Gold (ทองคำสว่าง)',
        springWarmLight: '💄 สี: Apricot (สีแอปริคอท), Light Coral (สีปะการังอ่อน), Ivory (สีงาช้าง), Cream (สีครีม)
💎 โลหะ: Rose Gold (ทองชมพู), Champagne Gold (ทองแชมเปญ)',
        autumnWarmDeep: '💄 สี: Burgundy (สีเบอร์กันดี), Chocolate Brown (สีน้ำตาลช็อกโกแลต), Deep Terracotta (สีดินเผาเข้ม)
💎 โลหะ: Antique Gold (ทองคำโบราณ), Bronze (สีบรอนซ์)',
        autumnWarmMuted: '💄 สี: Mustard (สีมัสตาร์ด), Olive (สีโอลีฟ), Khaki (สีขากี), Terracotta (สีดินเผา)
💎 โลหะ: Gold (ทองคำ), Brass (สีทองเหลือง)',
        autumnWarmSoft: '💄 สี: Camel (สีอูฐ), Salmon (สีแซลมอน), Soft Coral (สีปะการังอ่อน), Mocha (สีมอคค่า)
💎 โลหะ: Rose Gold (ทองชมพู), Antique Gold (ทองคำโบราณ)',
        summerCoolBright: '💄 สี: Rose Pink (สีชมพูกุหลาบ), Lavender (สีลาเวนเดอร์), Sky Blue (สีฟ้า)
💎 โลหะ: White Gold (ทองคำขาว), Rose Gold (ทองชมพู)',
        summerCoolLight: '💄 สี: Soft Pink (สีชมพูอ่อน), Lilac (สีไลแลค), Powder Blue (สีฟ้าอ่อน)
💎 โลหะ: Silver (สีเงิน), White Gold (ทองคำขาว)',
        winterCoolDeep: '💄 สี: Wine (สีไวน์), Royal Blue (สีน้ำเงินรอยัล), Emerald (สีมรกต), Black (สีดำ)
💎 โลหะ: Platinum (สีแพลทินัม), White Gold (ทองคำขาว)',
        winterCoolMuted: '💄 สี: Charcoal (สีชาร์โคล), Navy (สีกรมท่า), Burgundy (สีเบอร์กันดี), Dark Gray (สีเทาเข้ม)
💎 โลหะ: Silver (สีเงิน), Gunmetal (สีกันเมทัล)',
        neutralLight: '💄 สี: Dusty Pink (ชมพูอมเทา), Soft Beige (เบจอ่อน), Light Mauve (ม่วงอ่อน)
💎 โลหะ: Rose Gold (โรสโกลด์), Soft Silver (สีเงินอ่อน)',
        neutralDeep: '💄 สี: Taupe (สีน้ำตาลอมเทา), Mauve (สีม่วงอมเทา), Dark Brown (สีน้ำตาลเข้ม), Olive (สีโอลีฟ)
💎 โลหะ: Mixed Metals (โลหะผสม), Antique Silver (สีเงินโบราณ)'
      },
...
เมื่อสีผ้าทำให้สีผิวเป็นกลาง's complementary colors, the skin appears clearer; otherwise, the skin may look dull or reddish.',
        imageLabel: 'รูปภาพ:',
