...
// 지원 언어: 한국어(ko), 영어(en), 일본어(ja), 중국어(zh), 베트남어(vi), 인도네시아어(id), 스페인어(es), 태국어(th)
...
const HAIRGATOR_I18N = {
  ko: {
    ...
    ui: {
      ...
      noCard: '카드 없음',
      noSavedCard: '저장된 카드가 없습니다',
      deleteCard: '카드 삭제',
      daysUntilDowngrade: '일 후 무료 플랜으로 전환됩니다',
      downgradeToFree: '무료 플랜으로 전환',
      downgradeConfirmMessage: '무료 플랜으로 전환하시겠습니까?\n\n【무료 플랜 기능】\n• AI 챗봇 상담\n• 스타일 메뉴판 열람\n• 레시피/도해도 열람\n\n【제한되는 기능】\n• AI 룩북 생성\n• AI 헤어체험\n• AI 얼굴변환\n• AI 스타일매칭\n\n정말 전환하시겠습니까?',
      downgradeScheduled: '✅ 무료 플랜 전환이 예약되었습니다.\n\n• 현재 플랜 만료일까지 모든 기능 사용 가능\n• 만료일 이후 자동으로 무료 플랜 전환\n• 전환 시 보유 크레딧 초기화\n• 다음 결제일부터 결제 없음',
      cancelDowngradeConfirm: '무료 플랜 전환 예약을 취소하시겠습니까?\n\n취소하시면 현재 플랜이 유지됩니다.',
      downgradeCancelled: '전환 예약이 취소되었습니다.',
      errorOccurred: '오류가 발생했습니다. 잠시 후 다시 시도해주세요.',
      planWillSwitchToFree: '플랜이 {days}일 후 무료 플랜으로 전환됩니다. 만료 시 크레딧이 소멸됩니다.',
      planWillSwitchTo: '플랜이 {days}일 후 {plan} 플랜으로 전환됩니다.',
      planWillExpire: '플랜이 {days}일 후 만료됩니다. 만료 시 크레딧이 소멸됩니다.',
      planWillSwitchToFreeShort: '플랜이 {days}일 후 무료 플랜으로 전환됩니다.',
      planWillExpireShort: '플랜이 {days}일 후 만료됩니다.',
      planExpiry: '플랜 만료일',
      remainingTokens: '남은 토큰',
      termsOfService: '이용약관',
      privacyPolicy: '개인정보처리방침',
      locationTerms: '위치기반서비스 이용약관',
      ...
      daysLeft: '{days}일 남음',
      card: '카드',
      deleteCardConfirm: '저장된 카드를 삭제하시겠습니까?',
      cardDeleted: '카드가 삭제되었습니다.',
      cardDeleteFailed: '카드 삭제에 실패했습니다.',
      paymentError: '결제 처리 중 오류가 발생했습니다.',
      basicPlanRequired: '베이직 플랜 이상에서 사용 가능합니다.',
      insufficientTokens: '토큰이 부족합니다.',
      currentBalance: '현재 잔액',
      tokensNeeded: '{amount} 토큰이 필요합니다.',
      cardRegistered: '카드가 등록되었습니다!',
      cardRegisterFailed: '카드 등록에 실패했습니다.',
      featureComingSoon: '기능 준비 중입니다.',
      deleteThisCard: '이 카드를 삭제하시겠습니까?',
      featureAIStyleMatch: 'AI 스타일 매칭',
      featurePersonalColor: '퍼스널 이미지 분석',
      featureAITransform: 'AI 얼굴변환',
      tokenShortage: '토큰 부족',
      tokensRequiredFor: '{feature}에 {amount} 토큰이 필요합니다.',
      fullscreenToggle: '전체화면 토글',
      cardBrandBC: 'BC카드',
      cardBrandSamsung: '삼성카드',
      cardBrandHyundai: '현대카드',
      cardBrandShinhan: '신한카드',
      cardBrandLotte: '롯데카드',
      cardBrandKB: 'KB국민카드',
      cardBrandHana: '하나카드',
      cardBrandWoori: '우리카드',
      ...
      inquiryNotFound: '문의를 찾을 수 없습니다.',
      inquiryLoadFailed: '문의를 불러오는데 실패했습니다.',
    ...
    aiTransform: {
      ...
      hairstylePhoto: '헤어스타일 사진',
      original: '원본',
      referenceFace: '참조 얼굴',
      face: '얼굴',
      changeClothing: '의상 변경',
      ...
      clothing: {
        navySuit: '네이비 정장',
        whiteTshirt: '화이트 티셔츠',
        blackTurtleneck: '블랙 터틀넥',
        blueShirt: '라이트블루 셔츠',
        grayBlazer: '그레이 블레이저',
        blackDress: '블랙 원피스',
        whiteBlouse: '화이트 블라우스',
        navyJacket: '네이비 재킷',
        pinkKnit: '핑크 니트',
        creamCardigan: '크림 가디건'
      },
      background: {
        whiteStudio: '화이트 스튜디오',
        grayStudio: '그레이 스튜디오',
        gradient: '그라데이션',
        cementWall: '시멘트 벽',
        woodenWall: '나무 벽면',
  ...
  en: {
    ...
    ui: {
      ...
      downgradeConfirmMessage: 'Switch to Free plan?\n\n【Free Plan Features】\n• AI Chatbot consultation\n• Style menu browsing\n• Recipe/diagram access\n\n【Limited Features】\n• AI Lookbook generation\n• AI Hair Try-on\n• AI Face Swap\n• AI Style Matching\n\nDo you want to proceed?',
      downgradeScheduled: '✅ Free plan switch has been scheduled.\n\n• Use all features until current plan expires\n• Auto-switch to Free after expiry\n• Credits will be reset upon switching\n• No payment from next billing cycle',
      cancelDowngradeConfirm: 'Cancel the Free plan switch?\n\nYour current plan will be maintained if cancelled.',
      downgradeCancelled: 'Switch has been cancelled.',
      errorOccurred: 'An error occurred. Please try again later.',
      planWillSwitchToFree: 'Your plan will switch to Free in {days} days. Credits will expire.',
      planWillSwitchTo: 'Your plan will switch to {plan} in {days} days.',
      planWillExpire: 'Your plan will expire in {days} days. Credits will expire.',
      planWillSwitchToFreeShort: 'Your plan will switch to Free in {days} days.',
      planWillExpireShort: 'Your plan will expire in {days} days.',
      planExpiry: 'Plan Expiry',
      remainingTokens: 'Remaining Tokens',
      termsOfService: 'Terms of Service',
      privacyPolicy: 'Privacy Policy',
      locationTerms: 'Location Service Terms',
      ...
      basicPlanRequired: 'Basic plan or higher is required.',
      insufficientTokens: 'Insufficient tokens.',
      currentBalance: 'Current balance',
      tokensNeeded: '{amount} tokens required.',
      cardRegistered: 'Card has been registered!',
      cardRegisterFailed: 'Failed to register card.',
      featureComingSoon: 'Feature coming soon.',
      deleteThisCard: 'Delete this card?',
      featureAIStyleMatch: 'AI Style Match',
      featurePersonalColor: 'Personal Image Analysis',
      featureAITransform: 'AI Face Transform',
      tokenShortage: 'Insufficient Tokens',
      tokensRequiredFor: '{amount} tokens required for {feature}.',
      fullscreenToggle: 'Toggle Fullscreen',
      cardBrandBC: 'BC Card',
      cardBrandSamsung: 'Samsung Card',
      cardBrandHyundai: 'Hyundai Card',
      cardBrandShinhan: 'Shinhan Card',
      cardBrandLotte: 'Lotte Card',
      cardBrandKB: 'KB Kookmin Card',
      cardBrandHana: 'Hana Card',
      cardBrandWoori: 'Woori Card',
      cardBrandNH: 'NH Nonghyup Card',
      colorWhite: 'White',
      colorBlack: 'Black',
      colorGold: 'Gold',
      colorSilver: 'Silver',
      ...
      inquiryLoadFailed: 'Failed to load inquiry.',
    ...
    aiStudio: {
      ...
      retentionNotice: '💡 Chats are kept for 7 days',
    ...
    aiTransform: {
      ...
      clothing: {
        ...
        blackTurtleneck: 'Black Turtleneck',
        blueShirt: 'Light Blue Shirt',
        grayBlazer: 'Gray Blazer',
        blackDress: 'Black Dress',
        whiteBlouse: 'White Blouse',
        navyJacket: 'Navy Jacket',
        pinkKnit: 'Pink Knit',
        creamCardigan: 'Cream Cardigan'
      },
      background: {
        whiteStudio: 'White Studio',
        grayStudio: 'Gray Studio',
        gradient: 'Gradient',
        cementWall: 'Cement Wall',
  ...
  ja: {
    ...
    ui: {
      ...
      savedPaymentMethod: '保存された決済方法',
      noCard: 'カードなし',
      noSavedCard: '保存されたカードがありません',
      deleteCard: 'カード削除',
      daysUntilDowngrade: '日後に無料プランに変更されます',
      downgradeToFree: '無料プランに変更',
      downgradeConfirmMessage: '無料プランに変更しますか？\n\n【無料プラン機能】\n• AIチャットボット相談\n• スタイルメニュー閲覧\n• レシピ/図解アクセス\n\n【制限される機能】\n• AIルックブック生成\n• AIヘア体験\n• AI顔変換\n• AIスタイルマッチング\n\n続行しますか？',
      downgradeScheduled: '✅ 無料プランへの変更が予約されました。\n\n• 現在のプラン有効期限まで全機能利用可能\n• 有効期限後に自動的に無料プランに変更\n• 変更時にクレジットがリセット\n• 次回請求からお支払いなし',
      cancelDowngradeConfirm: '無料プランへの変更をキャンセルしますか？\n\nキャンセルすると現在のプランが維持されます。',
      downgradeCancelled: '変更がキャンセルされました。',
      errorOccurred: 'エラーが発生しました。後でもう一度お試しください。',
      planWillSwitchToFree: 'プランは{days}日後に無料プランに変更されます。クレジットが失効します。',
      planWillSwitchTo: 'プランは{days}日後に{plan}プランに変更されます。',
      planWillExpire: 'プランは{days}日後に有効期限が切れます。クレジットが失効します。',
      planWillSwitchToFreeShort: 'プランは{days}日後に無料プランに変更されます。',
      planWillExpireShort: 'プランは{days}日後に有効期限が切れます。',
      planExpiry: 'プラン有効期限',
      remainingTokens: '残りトークン',
      termsOfService: '利用規約',
      privacyPolicy: 'プライバシーポリシー',
      locationTerms: '位置情報サービス利用規約',
      ...
      daysLeft: '残り{days}日',
      card: 'カード',
      deleteCardConfirm: '保存されたカードを削除しますか？',
      cardDeleted: 'カードが削除されました。',
      cardDeleteFailed: 'カードの削除に失敗しました。',
      paymentError: '決済処理中にエラーが発生しました。',
      basicPlanRequired: 'ベーシックプラン以上が必要です。',
      insufficientTokens: 'トークンが不足しています。',
      currentBalance: '現在の残高',
      tokensNeeded: '{amount}トークンが必要です。',
      cardRegistered: 'カードが登録されました！',
      cardRegisterFailed: 'カードの登録に失敗しました。',
      featureComingSoon: '機能準備中です。',
      deleteThisCard: 'このカードを削除しますか？',
      featureAIStyleMatch: 'AIスタイルマッチ',
      featurePersonalColor: 'パーソナルイメージ分析',
      featureAITransform: 'AI顔変換',
      tokenShortage: 'トークン不足',
      tokensRequiredFor: '{feature}に{amount}トークンが必要です。',
      fullscreenToggle: 'フルスクリーン切替',
      cardBrandBC: 'BCカード',
      cardBrandSamsung: 'サムスンカード',
      cardBrandHyundai: '現代カード',
      cardBrandShinhan: '新韓カード',
      cardBrandLotte: 'ロッテカード',
      cardBrandKB: 'KB国民カード',
      cardBrandHana: 'ハナカード',
      cardBrandWoori: 'ウリカード',
      cardBrandNH: 'NH農協カード',
      colorWhite: 'ホワイト',
      colorBlack: 'ブラック',
      colorGold: 'ゴールド',
      ...
      inquiryNotFound: 'お問い合わせが見つかりません。',
      inquiryLoadFailed: 'お問い合わせの読み込みに失敗しました。',
    ...
    aiTransform: {
      menuTitle: 'AI顔変換',
      menuSubtitle: '顔合成・衣装/背景変更',
      headerTitle: 'AI顔変換',
      faceSwapTitle: 'AI顔変換',
      faceSwapDesc: '元のヘアスタイルを維持して顔のみを変換します',
      hairstylePhoto: 'ヘアスタイル写真',
      original: 'オリジナル',
      referenceFace: '参照顔',
      face: '顔',
      changeClothing: '衣装変更',
      ...
      clothing: {
        navySuit: 'ネイビースーツ',
        whiteTshirt: 'ホワイトTシャツ',
        blackTurtleneck: 'ブラックタートルネック',
        blueShirt: 'ライトブルーシャツ',
        grayBlazer: 'グレーブレザー',
        blackDress: 'ブラックワンピース',
        whiteBlouse: 'ホワイトブラウス',
        navyJacket: 'ネイビージャケット',
        pinkKnit: 'ピンクニット',
        creamCardigan: 'クリームカーディガン'
      },
      background: {
        whiteStudio: 'ホワイトスタジオ',
        grayStudio: 'グレースタジオ',
        gradient: 'グラデーション',
        cementWall: 'セメント壁',
        woodenWall: '木製壁',
  ...
  zh: {
    ...
    ui: {
      ...
      savedPaymentMethod: '已保存的支付方式',
      noCard: '无卡',
      noSavedCard: '没有已保存的卡',
      deleteCard: '删除卡',
      daysUntilDowngrade: '天后将切换到免费套餐',
      downgradeToFree: '切换到免费套餐',
      downgradeConfirmMessage: '切换到免费套餐吗？\n\n【免费套餐功能】\n• AI聊天机器人咨询\n• 风格菜单浏览\n• 配方/图解访问\n\n【受限功能】\n• AI造型书生成\n• AI发型体验\n• AI换脸\n• AI风格匹配\n\n是否继续？',
      downgradeScheduled: '✅ 免费套餐切换已预约。\n\n• 当前套餐到期前可使用所有功能\n• 到期后自动切换到免费套餐\n• 切换时积分将被重置\n• 下次账单周期起无需付款',
      cancelDowngradeConfirm: '取消免费套餐切换吗？\n\n取消后将保持当前套餐。',
      downgradeCancelled: '切换已取消。',
      errorOccurred: '发生错误。请稍后再试。',
      planWillSwitchToFree: '套餐将在{days}天后切换到免费套餐。积分将过期。',
      planWillSwitchTo: '套餐将在{days}天后切换到{plan}套餐。',
      planWillExpire: '套餐将在{days}天后到期。积分将过期。',
      planWillSwitchToFreeShort: '套餐将在{days}天后切换到免费套餐。',
      planWillExpireShort: '套餐将在{days}天后到期。',
      planExpiry: '套餐到期日',
      remainingTokens: '剩余积分',
      termsOfService: '服务条款',
      privacyPolicy: '隐私政策',
      ...
      daysLeft: '剩余{days}天',
      card: '卡',
      deleteCardConfirm: '删除此保存的卡？',
      cardDeleted: '卡已删除。',
      cardDeleteFailed: '删除卡失败。',
      paymentError: '支付处理过程中发生错误。',
      basicPlanRequired: '需要基础套餐或更高级别。',
      insufficientTokens: '积分不足。',
      currentBalance: '当前余额',
      tokensNeeded: '需要{amount}积分。',
      cardRegistered: '卡已注册！',
      cardRegisterFailed: '卡注册失败。',
      featureComingSoon: '功能即将推出。',
      deleteThisCard: '删除此卡？',
      featureAIStyleMatch: 'AI风格匹配',
      featurePersonalColor: '个人形象分析',
      featureAITransform: 'AI换脸',
      tokenShortage: '积分不足',
      tokensRequiredFor: '{feature}需要{amount}积分。',
      fullscreenToggle: '全屏切换',
      cardBrandBC: 'BC卡',
      cardBrandSamsung: '三星卡',
      cardBrandHyundai: '现代卡',
      cardBrandShinhan: '新韩卡',
      cardBrandLotte: '乐天卡',
      cardBrandKB: 'KB国民卡',
      cardBrandHana: '韩亚卡',
      cardBrandWoori: '友利卡',
      ...
      inquiryNotFound: '找不到咨询。',
      inquiryLoadFailed: '加载咨询失败。',
      enterSubject: '请输入标题。',
      enterMessage: '请输入内容。',
    ...
    aiTransform: {
      menuTitle: 'AI换脸',
      menuSubtitle: '面部合成·服装/背景更换',
      headerTitle: 'AI换脸',
      faceSwapTitle: 'AI换脸',
      faceSwapDesc: '保留原发型只转换面部',
      hairstylePhoto: '发型照片',
      original: '原图',
      referenceFace: '参考面部',
      face: '面部',
  ...
  vi: {
    ...
    ui: {
      ...
      savedPaymentMethod: 'Phương thức thanh toán đã lưu',
      noCard: 'Không có thẻ',
      noSavedCard: 'Không có thẻ đã lưu',
      deleteCard: 'Xóa thẻ',
      daysUntilDowngrade: ' ngày nữa sẽ chuyển sang gói Miễn phí',
      downgradeToFree: 'Chuyển sang gói Miễn phí',
      downgradeConfirmMessage: 'Chuyển sang gói Miễn phí?\n\n【Tính năng gói Miễn phí】\n• Tư vấn AI Chatbot\n• Xem menu kiểu tóc\n• Truy cập công thức/sơ đồ\n\n【Tính năng bị hạn chế】\n• Tạo AI Lookbook\n• Thử tóc AI\n• Đổi khuôn mặt AI\n• AI Style Matching\n\nBạn có muốn tiếp tục?',
      downgradeScheduled: '✅ Đã đặt lịch chuyển sang gói Miễn phí.\n\n• Sử dụng tất cả tính năng đến khi gói hiện tại hết hạn\n• Tự động chuyển sang Miễn phí sau khi hết hạn\n• Điểm tín dụng sẽ được đặt lại khi chuyển đổi\n• Không thanh toán từ chu kỳ tiếp theo',
      cancelDowngradeConfirm: 'Hủy chuyển đổi sang gói Miễn phí?\n\nGói hiện tại sẽ được duy trì nếu hủy.',
      downgradeCancelled: 'Đã hủy chuyển đổi.',
      errorOccurred: 'Đã xảy ra lỗi. Vui lòng thử lại sau.',
      planWillSwitchToFree: 'Gói của bạn sẽ chuyển sang Miễn phí sau {days} ngày. Điểm tín dụng sẽ hết hạn.',
      planWillSwitchTo: 'Gói của bạn sẽ chuyển sang {plan} sau {days} ngày.',
      planWillExpire: 'Gói của bạn sẽ hết hạn sau {days} ngày. Điểm tín dụng sẽ hết hạn.',
      planWillSwitchToFreeShort: 'Gói của bạn sẽ chuyển sang Miễn phí sau {days} ngày.',
      planWillExpireShort: 'Gói của bạn sẽ hết hạn sau {days} ngày.',
      planExpiry: 'Ngày hết hạn gói',
      remainingTokens: 'Điểm còn lại',
      termsOfService: 'Điều khoản dịch vụ',
      privacyPolicy: 'Chính sách bảo mật',
      locationTerms: 'Điều khoản dịch vụ vị trí',
      ...
      card: 'Thẻ',
      deleteCardConfirm: 'Xóa thẻ đã lưu này?',
      cardDeleted: 'Đã xóa thẻ.',
      cardDeleteFailed: 'Không thể xóa thẻ.',
      paymentError: 'Đã xảy ra lỗi trong quá trình thanh toán.',
      basicPlanRequired: 'Cần gói Basic trở lên.',
      insufficientTokens: 'Không đủ điểm.',
      currentBalance: 'Số dư hiện tại',
      tokensNeeded: 'Cần {amount} điểm.',
      cardRegistered: 'Đã đăng ký thẻ!',
      cardRegisterFailed: 'Không thể đăng ký thẻ.',
      featureComingSoon: 'Tính năng sắp ra mắt.',
      deleteThisCard: 'Xóa thẻ này?',
      featureAIStyleMatch: 'AI Kết Hợp Phong Cách',
      featurePersonalColor: 'Phân Tích Hình Ảnh Cá Nhân',
      featureAITransform: 'AI Biến Đổi Khuôn Mặt',
      tokenShortage: 'Không Đủ Điểm',
      tokensRequiredFor: '{feature} cần {amount} điểm.',
      fullscreenToggle: 'Chuyển đổi toàn màn hình',
      cardBrandBC: 'Thẻ BC',
      cardBrandSamsung: 'Thẻ Samsung',
      cardBrandHyundai: 'Thẻ Hyundai',
      cardBrandShinhan: 'Thẻ Shinhan',
      cardBrandLotte: 'Thẻ Lotte',
      cardBrandKB: 'Thẻ KB Kookmin',
      cardBrandHana: 'Thẻ Hana',
      cardBrandWoori: 'Thẻ Woori',
      cardBrandNH: 'Thẻ NH Nonghyup',
      colorWhite: 'Trắng',
      colorBlack: 'Đen',
      colorGold: 'Vàng',
      colorSilver: 'Bạc',
      ...
      inquiryNotFound: 'Không tìm thấy yêu cầu.',
      inquiryLoadFailed: 'Không thể tải yêu cầu.',
    ...
    aiStudio: {
      ...
      retentionNotice: '💡 Lưu giữ 7 ngày',
    ...
    // ========== AI Đổi Mặt ==========
    aiTransform: {
      menuTitle: 'AI Đổi Mặt',
      menuSubtitle: 'Ghép mặt · Đổi trang phục/nền',
      headerTitle: 'AI Đổi Mặt',
      faceSwapTitle: 'AI Đổi Mặt',
      faceSwapDesc: 'Giữ nguyên kiểu tóc và chỉ thay đổi khuôn mặt',
      hairstylePhoto: 'Ảnh kiểu tóc',
      original: 'Gốc',
      referenceFace: 'Khuôn mặt tham chiếu',
      face: 'Mặt',
      changeClothing: 'Đổi trang phục',
      changeBackground: 'Đổi nền',
      noChange: 'Không đổi',
      male: 'Nam',
      female: 'Nữ',
      clothing: {
        navySuit: 'Vest xanh navy',
        whiteTshirt: 'Áo phông trắng',
        blackTurtleneck: 'Áo cổ lọ đen',
        blueShirt: 'Sơ mi xanh nhạt',
        grayBlazer: 'Blazer xám',
        blackDress: 'Váy đen',
        whiteBlouse: 'Áo sơ mi trắng',
        navyJacket: 'Áo khoác xanh navy',
        pinkKnit: 'Áo len hồng',
        creamCardigan: 'Cardigan kem'
      },
      background: {
        whiteStudio: 'Studio trắng',
        grayStudio: 'Studio xám',
        gradient: 'Chuyển màu',
        cementWall: 'Tường xi măng',
        woodenWall: 'Tường gỗ',
        bokeh: 'Bokeh mờ'
      },
  ...
  id: {
    ...
    ui: {
      ...
      savedPaymentMethod: 'Metode Pembayaran Tersimpan',
      noCard: 'Tidak ada kartu',
      noSavedCard: 'Tidak ada kartu tersimpan',
      deleteCard: 'Hapus Kartu',
      daysUntilDowngrade: ' hari lagi akan beralih ke paket Gratis',
      downgradeToFree: 'Beralih ke Paket Gratis',
      downgradeConfirmMessage: 'Beralih ke paket Gratis?\n\n【Fitur Paket Gratis】\n• Konsultasi AI Chatbot\n• Melihat menu gaya\n• Akses resep/diagram\n\n【Fitur Terbatas】\n• Pembuatan AI Lookbook\n• Coba rambut AI\n• Tukar wajah AI\n• AI Style Matching\n\nApakah Anda ingin melanjutkan?',
      downgradeScheduled: '✅ Peralihan ke paket Gratis telah dijadwalkan.\n\n• Gunakan semua fitur hingga paket saat ini kedaluwarsa\n• Otomatis beralih ke Gratis setelah kedaluwarsa\n• Kredit akan direset saat beralih\n• Tidak ada pembayaran dari siklus berikutnya',
      cancelDowngradeConfirm: 'Batalkan peralihan ke paket Gratis?\n\nPaket saat ini akan dipertahankan jika dibatalkan.',
      downgradeCancelled: 'Peralihan telah dibatalkan.',
      errorOccurred: 'Terjadi kesalahan. Silakan coba lagi nanti.',
      planWillSwitchToFree: 'Paket Anda akan beralih ke Gratis dalam {days} hari. Kredit akan kedaluwarsa.',
      planWillSwitchTo: 'Paket Anda akan beralih ke {plan} dalam {days} hari.',
      planWillExpire: 'Paket Anda akan kedaluwarsa dalam {days} hari. Kredit akan kedaluwarsa.',
      planWillSwitchToFreeShort: 'Paket Anda akan beralih ke Gratis dalam {days} hari.',
      planWillExpireShort: 'Paket Anda akan kedaluwarsa dalam {days} hari.',
      planExpiry: 'Tanggal Kedaluwarsa Paket',
      remainingTokens: 'Token Tersisa',
      termsOfService: 'Ketentuan Layanan',
      privacyPolicy: 'Kebijakan Privasi',
      locationTerms: 'Ketentuan Layanan Lokasi',
      loadError: 'Terjadi kesalahan saat memuat.',
      loginNeeded: 'Perlu masuk',
      defaultUser: 'Pengguna',
      planExpired: 'Kedaluwarsa',
      daysLeft: '{days} hari tersisa',
      card: 'Kartu',
      deleteCardConfirm: 'Hapus kartu tersimpan ini?',
      cardDeleted: 'Kartu telah dihapus.',
      cardDeleteFailed: 'Gagal menghapus kartu.',
      paymentError: 'Terjadi kesalahan saat memproses pembayaran.',
      basicPlanRequired: 'Diperlukan paket Basic atau lebih tinggi.',
      insufficientTokens: 'Token tidak cukup.',
      currentBalance: 'Saldo saat ini',
      tokensNeeded: 'Diperlukan {amount} token.',
      cardRegistered: 'Kartu telah terdaftar!',
      cardRegisterFailed: 'Gagal mendaftarkan kartu.',
      featureComingSoon: 'Fitur segera hadir.',
      deleteThisCard: 'Hapus kartu ini?',
      featureAIStyleMatch: 'AI Pencocokan Gaya',
      featurePersonalColor: 'Analisis Citra Pribadi',
      featureAITransform: 'AI Transformasi Wajah',
      tokenShortage: 'Token Tidak Cukup',
      tokensRequiredFor: '{feature} memerlukan {amount} token.',
      fullscreenToggle: 'Alihkan Layar Penuh',
      cardBrandBC: 'Kartu BC',
      cardBrandSamsung: 'Kartu Samsung',
      cardBrandHyundai: 'Kartu Hyundai',
      cardBrandShinhan: 'Kartu Shinhan',
      cardBrandLotte: 'Kartu Lotte',
      cardBrandKB: 'Kartu KB Kookmin',
      cardBrandHana: 'Kartu Hana',
      cardBrandWoori: 'Kartu Woori',
      cardBrandNH: 'Kartu NH Nonghyup',
      colorWhite: 'Putih',
      colorBlack: 'Hitam',
      colorGold: 'Emas',
      colorSilver: 'Perak',
      ...
      colorRed: 'Merah',
      colorGreen: 'Hijau',
      inquiryNotFound: 'Pertanyaan tidak ditemukan.',
      inquiryLoadFailed: 'Gagal memuat pertanyaan.',
      inquirySubmitFailed: 'Gagal mengirim pertanyaan.',
      myPlan: 'Paket Saya',
      myTokens: 'Token Saya',
      ...
      loginStatus: 'Login',
      guest: 'Tamu',
      noticeMenu: 'Pengumuman',
      noNotices: 'Tidak ada pengumuman.',
      noticeEmpty: 'Tidak ada pengumuman yang terdaftar.',
      noticeLoadFailed: 'Tidak dapat memuat pengumuman.',
      noticeNotFound: 'Pengumuman tidak ditemukan.',
      backToList: '← Kembali ke daftar',
      noTitle: 'Tidak ada judul',
      inquiryTitle: 'Kirim Pertanyaan',
      subjectLabel: 'Subjek',
      subjectPlaceholder: 'Masukkan subjek pertanyaan Anda',
      contentLabel: 'Isi',
      contentPlaceholder: 'Silakan jelaskan pertanyaan Anda secara detail',
      imageAttachOptional: 'Lampirkan gambar (Opsional)',
      selectImage: '📷 Pilih gambar',
      cancel: 'Batal',
      submitInquiry: 'Kirim pertanyaan',
      submitting: 'Mengirim...',
      inquirySubmitted: 'Pertanyaan Anda telah dikirim.',
      enterSubject: 'Silakan masukkan subjek.',
      enterMessage: 'Silakan masukkan isi.',
      fileTooLarge: 'File harus kurang dari 5MB.',
    ...
    aiStudio: {
      ...
      pinnedChats: 'Disematkan',
      recentChats: 'Terbaru',
      noConversations: 'Belum ada percakapan',
      retentionNotice: '💡 Disimpan 7 hari',
    ...
    // ========== AI Ganti Wajah ==========
    aiTransform: {
      menuTitle: 'AI Ganti Wajah',
      menuSubtitle: 'Ganti Wajah · Pakaian/Latar',
      headerTitle: 'AI Ganti Wajah',
      faceSwapTitle: 'AI Ganti Wajah',
      faceSwapDesc: 'Pertahankan gaya rambut asli dan ubah wajah saja',
      hairstylePhoto: 'Foto Gaya Rambut',
      original: 'Asli',
      referenceFace: 'Wajah Referensi',
      face: 'Wajah',
      changeClothing: 'Ubah Pakaian',
      changeBackground: 'Ubah Latar',
      noChange: 'Tidak Berubah',
      male: 'Pria',
      female: 'Wanita',
      clothing: {
        navySuit: 'Jas Navy',
        whiteTshirt: 'Kaos Putih',
        blackTurtleneck: 'Turtleneck Hitam',
        blueShirt: 'Kemeja Biru Muda',
        grayBlazer: 'Blazer Abu-abu',
        blackDress: 'Gaun Hitam',
        whiteBlouse: 'Blus Putih',
        navyJacket: 'Jaket Navy',
        pinkKnit: 'Rajutan Pink',
        creamCardigan: 'Kardigan Krem'
      },
      background: {
        whiteStudio: 'Studio Putih',
        grayStudio: 'Studio Abu-abu',
        gradient: 'Gradien',
        cementWall: 'Dinding Semen',
        woodenWall: 'Dinding Kayu',
        bokeh: 'Blur Bokeh'
      },
      startFaceSwap: 'Mulai Ganti Wajah',
      tokens: 'Token',
      save: 'Simpan',
      tryAgain: 'Coba Lagi',
  ...
  es: {
    ...
    ui: {
      ...
      noCard: 'Sin tarjeta',
      noSavedCard: 'No hay tarjeta guardada',
      deleteCard: 'Eliminar Tarjeta',
      daysUntilDowngrade: ' días hasta cambiar al plan Gratis',
      downgradeToFree: 'Cambiar a Plan Gratis',
      downgradeConfirmMessage: '¿Cambiar al plan Gratis?\n\n【Funciones del Plan Gratis】\n• Consulta con chatbot AI\n• Ver menú de estilos\n• Acceso a recetas/diagramas\n\n【Funciones Limitadas】\n• Generación de AI Lookbook\n• Prueba de cabello AI\n• Cambio de cara AI\n• AI Style Matching\n\n¿Desea continuar?',
      downgradeScheduled: '✅ El cambio al plan Gratis ha sido programado.\n\n• Use todas las funciones hasta que expire su plan actual\n• Cambio automático a Gratis después del vencimiento\n• Los créditos se restablecerán al cambiar\n• Sin pago desde el próximo ciclo de facturación',
      cancelDowngradeConfirm: '¿Cancelar el cambio al plan Gratis?\n\nSu plan actual se mantendrá si cancela.',
      downgradeCancelled: 'El cambio ha sido cancelado.',
      errorOccurred: 'Se produjo un error. Por favor, inténtelo de nuevo más tarde.',
      planWillSwitchToFree: 'Su plan cambiará a Gratis en {days} días. Los créditos expirarán.',
      planWillSwitchTo: 'Su plan cambiará a {plan} en {days} días.',
      planWillExpire: 'Su plan expirará en {days} días. Los créditos expirarán.',
      planWillSwitchToFreeShort: 'Su plan cambiará a Gratis en {days} días.',
      planWillExpireShort: 'Su plan expirará en {days} días.',
      planExpiry: 'Fecha de Vencimiento del Plan',
      remainingTokens: 'Tokens Restantes',
      termsOfService: 'Términos de Servicio',
      privacyPolicy: 'Política de Privacidad',
      locationTerms: 'Términos del Servicio de Ubicación',
      loadError: 'Se produjo un error al cargar.',
      loginNeeded: 'Inicio de sesión requerido',
      defaultUser: 'Usuario',
      planExpired: 'Expirado',
      daysLeft: '{days} días restantes',
      card: 'Tarjeta',
      deleteCardConfirm: '¿Eliminar esta tarjeta guardada?',
      cardDeleted: 'La tarjeta ha sido eliminada.',
      cardDeleteFailed: 'Error al eliminar la tarjeta.',
      paymentError: 'Se produjo un error durante el procesamiento del pago.',
      basicPlanRequired: 'Se requiere el plan Básico o superior.',
      insufficientTokens: 'Tokens insuficientes.',
      currentBalance: 'Saldo actual',
      tokensNeeded: 'Se requieren {amount} tokens.',
      cardRegistered: '¡Tarjeta registrada!',
      cardRegisterFailed: 'Error al registrar la tarjeta.',
      featureComingSoon: 'Función próximamente.',
      deleteThisCard: '¿Eliminar esta tarjeta?',
      featureAIStyleMatch: 'AI Combinación de Estilos',
      featurePersonalColor: 'Análisis de Imagen Personal',
      featureAITransform: 'AI Transformación Facial',
      tokenShortage: 'Tokens Insuficientes',
      tokensRequiredFor: '{feature} requiere {amount} tokens.',
      fullscreenToggle: 'Alternar Pantalla Completa',
      cardBrandBC: 'Tarjeta BC',
      cardBrandSamsung: 'Tarjeta Samsung',
      cardBrandHyundai: 'Tarjeta Hyundai',
      cardBrandShinhan: 'Tarjeta Shinhan',
      cardBrandLotte: 'Tarjeta Lotte',
      cardBrandKB: 'Tarjeta KB Kookmin',
      cardBrandHana: 'Tarjeta Hana',
      cardBrandWoori: 'Tarjeta Woori',
      cardBrandNH: 'Tarjeta NH Nonghyup',
      colorWhite: 'Blanco',
      colorBlack: 'Negro',
      colorGold: 'Dorado',
      ...
      colorRed: 'Rojo',
      colorGreen: 'Verde',
      inquiryNotFound: 'Consulta no encontrada.',
      inquiryLoadFailed: 'Error al cargar la consulta.',
      inquirySubmitFailed: 'Error al enviar la consulta.',
      myPlan: 'Mi Plan',
      myTokens: 'Mis Tokens',
      ...
      noticeEmpty: 'No hay avisos registrados.',
      noticeLoadFailed: 'No se pueden cargar los avisos.',
      noticeNotFound: 'Aviso no encontrado.',
      backToList: '← Volver a la lista',
      noTitle: 'Sin título',
      inquiryTitle: 'Enviar Consulta',
      subjectLabel: 'Asunto',
      subjectPlaceholder: 'Ingrese el asunto de su consulta',
      contentLabel: 'Contenido',
      contentPlaceholder: 'Por favor, describa su consulta en detalle',
      imageAttachOptional: 'Adjuntar imagen (Opcional)',
      selectImage: '📷 Seleccionar imagen',
      cancel: 'Cancelar',
      submitInquiry: 'Enviar consulta',
      submitting: 'Enviando...',
      inquirySubmitted: 'Su consulta ha sido enviada.',
      enterSubject: 'Por favor, ingrese un asunto.',
      enterMessage: 'Por favor, ingrese el contenido.',
    ...
    aiStudio: {
      ...
      retentionNotice: '💡 Se guardan 7 días',
    ...
    // ========== AI Cambio de Cara ==========
    aiTransform: {
      menuTitle: 'AI Cambio de Cara',
      menuSubtitle: 'Cambio de Cara · Ropa/Fondo',
      headerTitle: 'AI Cambio de Cara',
      faceSwapTitle: 'AI Cambio de Cara',
      faceSwapDesc: 'Mantener el peinado original y cambiar solo la cara',
      hairstylePhoto: 'Foto de Peinado',
      original: 'Original',
      referenceFace: 'Cara de Referencia',
      face: 'Cara',
      changeClothing: 'Cambiar Ropa',
      changeBackground: 'Cambiar Fondo',
      noChange: 'Sin Cambio',
      male: 'Masculino',
      female: 'Femenino',
      clothing: {
        navySuit: 'Traje Azul Marino',
        whiteTshirt: 'Camiseta Blanca',
        blackTurtleneck: 'Cuello Alto Negro',
        blueShirt: 'Camisa Azul Claro',
        grayBlazer: 'Blazer Gris',
        blackDress: 'Vestido Negro',
        whiteBlouse: 'Blusa Blanca',
        navyJacket: 'Chaqueta Azul Marino',
        pinkKnit: 'Punto Rosa',
        creamCardigan: 'Cárdigan Crema'
      },
      background: {
        whiteStudio: 'Estudio Blanco',
        grayStudio: 'Estudio Gris',
        gradient: 'Degradado',
        cementWall: 'Pared de Cemento',
        woodenWall: 'Pared de Madera',
        bokeh: 'Desenfoque Bokeh'
      },
      startFaceSwap: 'Iniciar Cambio de Cara',
      tokens: 'Tokens',
      save: 'Guardar',
      tryAgain: 'Reintentar',
  ...
  th: {
    ...
    // ========== ชื่อหมวดหมู่ ==========
    categories: {
      'SIDE FRINGE': 'Side Fringe (หน้าม้าปัดข้าง)',
      'SIDE PART': 'Side Part (แสกข้าง)',
      'FRINGE UP': 'Fringe Up (หน้าม้าตั้งขึ้น)',
      'PUSHED BACK': 'Pushed Back (เสยไปด้านหลัง)',
      'BUZZ': 'Buzz Cut (บัตซ์คัต)',
      'CROP': 'Crop Cut',
      'MOHICAN': 'Mohican (โมฮิกัน)',

      'A LENGTH': 'ความยาวระดับ A',
      'B LENGTH': 'ความยาวระดับ B',
      'C LENGTH': 'ความยาวระดับ C',
      'D LENGTH': 'ความยาวระดับ D',
      'E LENGTH': 'ความยาวระดับ E',
      'F LENGTH': 'ความยาวระดับ F',
      'G LENGTH': 'ความยาวระดับ G',
      'H LENGTH': 'ความยาวระดับ H'
    },

    // ========== คำอธิบายหมวดหมู่ ==========
    descriptions: {
      'SIDE FRINGE': 'ผมหน้าม้าที่ตกลงมาด้านหน้าอย่างเป็นธรรมชาติ เหมาะสำหรับปรับสมดุลรูปหน้าสามเหลี่ยมที่มีหน้าผากเด่น สร้างลุคที่อ่อนโยนและอ่อนไหว',
      'SIDE PART': 'ทรงผมที่แสกข้าง คลาสสิกเมื่อหวีเสยไปด้านหลัง สบายๆ เมื่อปล่อยลงมา ปรับใช้ได้หลากหลายสำหรับรูปหน้าต่างๆ ใช้งานง่าย',
      'FRINGE UP': 'ผมที่ไหลไปข้างหน้าโดยมีผมหน้าม้ายกขึ้น เผยให้เห็นหน้าผากอย่างพอเหมาะเพื่อลุคที่สดใสและซับซ้อน สร้างสไตล์ที่กระฉับกระเฉงและสะอาดตา',
      'PUSHED BACK': 'ผมที่ไหลไปข้างหลังอย่างเป็นธรรมชาติ เผยให้เห็นหน้าผากเพื่อลุคที่เรียบร้อย คลาสสิก และทันสมัย เหมาะสำหรับลุคธุรกิจและทางการ',
      'BUZZ': 'ทรงผมสั้นที่สุดสำหรับผู้ชาย เผยให้เห็นรูปทรงศีรษะและรูปทรงใบหน้าได้ชัดเจน สร้างภาพลักษณ์ที่เรียบง่ายและดูแลง่าย',
      'CROP': 'ยาวกว่าสกินเฮดเล็กน้อย โดยมีผมหน้าม้าปิดหน้าผากส่วนบนเล็กน้อย สามารถแสดงพื้นผิวและวอลลุ่มด้วยความรู้สึกที่ทันสมัยและเก๋ไก๋',
      'MOHICAN': 'ตรงกลางด้านบนยกขึ้นเพื่อเน้น ด้านข้างที่สั้นกว่าสร้างมุมและเส้นที่ชัดเจน แสดงออกถึงบุคลิกที่แข็งแกร่ง พลังงาน และอารมณ์สตรีท',

      'A LENGTH': 'ความยาวระดับ A คือผมยาวเลยเส้นหน้าอก เหมาะสำหรับผมตรงยาว ผมยาวเลเยอร์ และผมลอน S หนา เพื่อบรรยากาศที่สง่างามและน่าทึ่ง',
      'B LENGTH': 'ความยาวระดับ B คือผมยาวปานกลางระหว่างใต้เส้นหน้าอก (A) และใต้กระดูกไหปลาร้า (C) เหมาะสำหรับผมยาวปานกลางเลเยอร์และดัดวอลลุ่ม (Body Perm) เพื่อความประทับใจที่นุ่มนวลและใช้งานได้จริง',
      'C LENGTH': 'ความยาวระดับ C คือผมกึ่งยาวใต้เส้นกระดูกไหปลาร้า เหมาะสำหรับผมลอน C/S เลเยอร์เพื่ออารมณ์สำนักงานที่เรียบร้อยและซับซ้อน',
      'D LENGTH': 'ความยาวระดับ D ยาวถึงไหล่พอดี เหมาะสำหรับผมลอน C ระดับไหล่ (Shoulder C-curl) ให้ความรู้สึกทันสมัยและสะอาดตา',
      'E LENGTH': 'ความยาวระดับ E คือผมบ๊อบเหนือไหล่เล็กน้อย เหมาะสำหรับผมบ๊อบคลาสสิก บ๊อบ A-line และผมลอน C เข้า/ออก (inward/outward C-curl) เพื่อความประทับใจที่มีชีวิตชีวาและทันสมัย',
      'F LENGTH': 'ความยาวระดับ F คือผมบ๊อบใต้กรามเล็กน้อย เหมาะสำหรับเฟรนช์บ๊อบ (French bob) บ๊อบตรง (Straight bob) และเท็กซ์เจอร์บ๊อบ (Texture bob) เพื่อบรรยากาศที่เก๋ไก๋และทันสมัย',
      'G LENGTH': 'ความยาวระดับ G คือผมมินิบ๊อบเหนือขากรรไกร เหมาะสำหรับผมบ๊อบระดับกรามคลาสสิกและมินิบ๊อบเลเยอร์เพื่ออารมณ์ที่เรียบร้อยและมินิมอล',
      'H LENGTH': 'ความยาวระดับ H คือผมสั้นตั้งแต่ระดับใบหูถึงช่วงสั้นมาก สำหรับสไตล์ที่กระฉับกระเฉงและมีเอกลักษณ์'
    },
    ...
    ui: {
      ...
      personalColor: 'Personal Image Analysis (วิเคราะห์ภาพส่วนตัว)',
      personalColorDesc: 'การวิเคราะห์จากข้อมูลสีผม 614 สี',
      brandSetting: 'การตั้งค่าแบรนด์',

      // Brand setting modal
      brandNameLabel: 'ชื่อแบรนด์ (เว้นว่างสำหรับ HAIRGATOR)',
      brandNamePlaceholder: 'เช่น SALON BEAUTY',
      fontSelect: 'เลือกฟอนต์ (Select Font)',
      fontPreview: 'Aa Bb',
      fontColorLight: '☀️ สีฟอนต์โหมดสว่าง (Light Mode Font Color)',
      fontColorDark: '🌙 สีฟอนต์โหมดมืด (Dark Mode Font Color)',
      preview: 'แสดงตัวอย่าง (Preview)',
      previewLight: '☀️ สว่าง (Light)',
      previewDark: '🌙 มืด (Dark)',
      reset: 'รีเซ็ต (Reset)',
      save: 'บันทึก (Save)',
      brandSaved: 'บันทึกการตั้งค่าแบรนด์แล้ว (Brand settings saved.)',
      saveFailed: 'บันทึกล้มเหลว (Save failed)',
      // Font names
      fontDefault: 'ค่าเริ่มต้น (Default)',
      fontNotoSans: 'Noto Sans',
      fontNanumGothic: 'Nanum Gothic',
      fontSpoqa: 'Spoqa Han Sans',
      fontMontserrat: 'Montserrat',
      ...
      // Mypage menu
      paymentManage: 'วิธีการชำระเงิน (Payment Methods)',
      paymentHistory: 'ประวัติการชำระเงิน (Payment History)',
      noPaymentHistory: 'ไม่มีประวัติการชำระเงิน (No payment history.)',
      viewReceipt: 'ดูใบเสร็จ (View Receipt)',
      receiptNotAvailable: 'การชำระเงินถูกยกเลิก (Cancelled Payment)',
      paymentCompleted: 'เสร็จสมบูรณ์ (Completed)',
      paymentCancelled: 'ยกเลิก (Cancelled)',
      paymentRefunded: 'คืนเงินแล้ว (Refunded)',
      planBasic: 'Basic',
      planPro: 'Pro',
      planBusiness: 'Business',
      tokensAdditional: 'โทเค็นเพิ่มเติม (Additional Tokens)',
      currencyWon: ' วอน (KRW)',
      tokens: 'โทเค็น (tokens)',
      languageSetting: 'ภาษา (Language)',
      customerService: 'บริการลูกค้า (Customer Service)',
      csHours: 'วันธรรมดา 10:00~17:00',
      inquiryMenu: 'ติดต่อเรา',
      noSavedCards: 'ไม่มีบัตรที่บันทึกไว้ (No saved cards.)',
      addCard: 'เพิ่มบัตร (Add Card)',
      noInquiries: 'ไม่มีคำถาม (No inquiries.)',
      newInquiry: 'คำถามใหม่ (New Inquiry)',
      savedPaymentMethods: 'วิธีการชำระเงินที่บันทึกไว้ (Saved Payment Methods)',
      savedPaymentMethod: 'วิธีการชำระเงินที่บันทึกไว้ (Saved Payment Method)',
      noCard: 'ไม่มีบัตร (No Card)',
      noSavedCard: 'ไม่มีบัตรที่บันทึกไว้ (No saved card)',
      deleteCard: 'ลบบัตร (Delete Card)',
      daysUntilDowngrade: ' วันจนกว่าจะเปลี่ยนเป็นแผนฟรี ( days until switching to Free plan)',
      downgradeToFree: 'เปลี่ยนเป็นแผนฟรี (Switch to Free Plan)',
      downgradeConfirmMessage: 'เปลี่ยนเป็นแผนฟรีหรือไม่?\n\n【คุณสมบัติแผนฟรี】\n• ปรึกษา AI Chatbot\n• เรียกดูเมนูทรงผม\n• เข้าถึงสูตร/แผนภาพ\n\n【คุณสมบัติที่จำกัด】\n• สร้าง AI Lookbook\n• ลองทรงผมด้วย AI\n• สลับใบหน้าด้วย AI\n• จับคู่สไตล์ด้วย AI\n\nคุณต้องการดำเนินการต่อหรือไม่?',
      downgradeScheduled: '✅ กำหนดการเปลี่ยนเป็นแผนฟรีเรียบร้อยแล้ว\n\n• ใช้คุณสมบัติทั้งหมดจนกว่าแผนปัจจุบันจะหมดอายุ\n• เปลี่ยนเป็นแผนฟรีโดยอัตโนมัติหลังจากหมดอายุ\n• เครดิตจะถูกรีเซ็ตเมื่อเปลี่ยน\n• ไม่มีการชำระเงินจากรอบการเรียกเก็บเงินถัดไป',
      cancelDowngradeConfirm: 'ยกเลิกการเปลี่ยนเป็นแผนฟรีหรือไม่?\n\nแผนปัจจุบันของคุณจะยังคงอยู่หากยกเลิก',
      downgradeCancelled: 'การเปลี่ยนแผนถูกยกเลิกแล้ว',
      errorOccurred: 'เกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้งในภายหลัง',
      planWillSwitchToFree: 'แผนของคุณจะเปลี่ยนเป็นแผนฟรีใน {days} วัน เครดิตจะหมดอายุ',
      planWillSwitchTo: 'แผนของคุณจะเปลี่ยนเป็น {plan} ใน {days} วัน',
      planWillExpire: 'แผนของคุณจะหมดอายุใน {days} วัน เครดิตจะหมดอายุ',
      planWillSwitchToFreeShort: 'แผนของคุณจะเปลี่ยนเป็นแผนฟรีใน {days} วัน',
      planWillExpireShort: 'แผนของคุณจะหมดอายุใน {days} วัน',
      planExpiry: 'วันหมดอายุของแผน',
      remainingTokens: 'โทเค็นคงเหลือ',
      termsOfService: 'ข้อกำหนดในการให้บริการ',
      privacyPolicy: 'นโยบายความเป็นส่วนตัว',
      locationTerms: 'ข้อกำหนดในการใช้บริการตำแหน่งที่ตั้ง',
      loadError: 'เกิดข้อผิดพลาดขณะโหลด',
      loginNeeded: 'ต้องเข้าสู่ระบบ',
      defaultUser: 'ผู้ใช้',
      planExpired: 'หมดอายุ',
      daysLeft: '{days} วัน',
      card: 'บัตร',
      deleteCardConfirm: 'ลบบัตรที่บันทึกไว้นี้หรือไม่?',
      cardDeleted: 'บัตรถูกลบแล้ว',
      cardDeleteFailed: 'ไม่สามารถลบบัตรได้',
      paymentError: 'เกิดข้อผิดพลาดระหว่างการดำเนินการชำระเงิน',
      basicPlanRequired: 'ต้องใช้แผน Basic หรือสูงกว่า',
      insufficientTokens: 'โทเค็นไม่เพียงพอ',
      currentBalance: 'ยอดเงินปัจจุบัน',
      tokensNeeded: 'ต้องใช้ {amount} โทเค็น',
      cardRegistered: 'ลงทะเบียนบัตรเรียบร้อยแล้ว!',
      cardRegisterFailed: 'ไม่สามารถลงทะเบียนบัตรได้',
      featureComingSoon: 'คุณสมบัติจะมาเร็วๆ นี้',
      deleteThisCard: 'ลบบัตรนี้หรือไม่?',
      featureAIStyleMatch: 'จับคู่สไตล์ด้วย AI',
      featurePersonalColor: 'Personal Image Analysis (วิเคราะห์ภาพส่วนตัว)',
      featureAITransform: 'AI Face Transform (แปลงใบหน้าด้วย AI)',
      tokenShortage: 'โทเค็นไม่เพียงพอ',
      tokensRequiredFor: 'ต้องใช้ {amount} โทเค็นสำหรับ {feature}',
      fullscreenToggle: 'สลับเป็นโหมดเต็มหน้าจอ',
      cardBrandBC: 'BC Card',
      cardBrandSamsung: 'Samsung Card',
      cardBrandHyundai: 'Hyundai Card',
      cardBrandShinhan: 'Shinhan Card',
      ...
      noticeEmpty: 'ไม่มีประกาศ',
      noticeLoadFailed: 'ไม่สามารถโหลดประกาศได้',
      noticeNotFound: 'ไม่พบประกาศ',
      backToList: '← กลับสู่รายการ',
      noTitle: 'ไม่มีหัวข้อ',

      // Inquiry form
      inquiryTitle: 'ติดต่อเรา',
      subjectLabel: 'หัวข้อ',
      subjectPlaceholder: 'ใส่หัวข้อเรื่องที่ต้องการสอบถาม',
      contentLabel: 'ข้อความ',
      contentPlaceholder: 'กรุณาอธิบายรายละเอียดข้อสงสัยของคุณ',
      imageAttachOptional: 'แนบรูปภาพ (ไม่บังคับ)',
      selectImage: '📷 เลือกรูปภาพ',
      cancel: 'ยกเลิก',
      withdrawAccount: 'ลบบัญชี',
      withdrawConfirmTitle: 'ลบบัญชี',
      withdrawConfirmMessage: 'คุณแน่ใจหรือไม่ว่าต้องการลบบัญชีของคุณ',
      withdrawWarning: 'ข้อมูลทั้งหมดจะถูกลบอย่างถาวรและไม่สามารถกู้คืนได้',
      confirmWithdraw: 'ลบบัญชี',
      submitInquiry: 'ส่ง',
      submitting: 'กำลังส่ง...',
      inquirySubmitted: 'คำถามของคุณถูกส่งเรียบร้อยแล้ว',
      inquirySubmitFailed: 'ไม่สามารถส่งคำถามได้',
      inquiryNotFound: 'ไม่พบคำถาม',
      inquiryLoadFailed: 'ไม่สามารถโหลดคำถามได้',
      enterSubject: 'กรุณาใส่หัวข้อ',
      enterMessage: 'กรุณาใส่ข้อความ',
      ...
      tokenBalanceLabel: 'ยอดคงเหลือโทเค็น',
      chargeTokens: 'เติมโทเค็น',
      upgradePlan: 'อัปเกรดแผน',

      // Profile photo
      profilePhoto: '📷 รูปโปรไฟล์',
      profilePhotoHint: 'รูปโปรไฟล์ของคุณจะใช้สำหรับการปรึกษาสไตล์',
      profilePhotoHint2: 'กรุณาเลือกรูปภาพที่เห็นใบหน้าของคุณชัดเจน',
      profilePhotoHint3: '.',
      selectPhoto: 'เลือกรูปภาพ',
      deletePhoto: 'ลบรูปภาพ',
      profileDeleted: 'ลบรูปโปรไฟล์แล้ว',
      profileSaved: 'บันทึกรูปโปรไฟล์แล้ว',

      // Idle screen
      touchToReturn: 'แตะเพื่อกลับ',
      ...
      selectGender: 'โปรดเลือกเพศ',
      loading: 'กำลังโหลด...',
      noStyles: 'ไม่มีสไตล์ที่สามารถใช้งานได้',
      ...
      credit: 'เครดิต',
      loginStatus: 'เข้าสู่ระบบ',
      guest: 'ผู้เยี่ยมชม'
    },

    // ========== AI Studio Chatbot ==========
    aiStudio: {
      welcomeTitle: 'สวัสดี! ฉันคือ HAIRGATOR AI',
      welcomeMessage: 'อัปโหลดรูปทรงผมหรือถามคำถาม เราให้การวิเคราะห์และสูตรอย่างมืออาชีพโดยอิงจากระบบ 2WAY CUT',
      inputPlaceholder: 'ใส่คำถามของคุณ...',
      uploadTooltip: 'อัปโหลดรูปภาพ',
      genderLabel: 'เลือกเพศ:',
      genderFemale: 'หญิง (Female)',
      genderMale: 'ชาย (Male)',
      quickALength: 'A Length คืออะไร?',
      quickLayerGrad: 'Layer (เลเยอร์) vs Graduation (แกรดูเอชั่น)',
      quickLifting: 'อธิบาย Lifting',
      quickDamagedPerm: 'สูตรดัดผมสำหรับผมเสียอย่างรุนแรง (Severely Damaged Hair Perm Recipe)',
      quickHardenedHair: 'วิธีการดัดผมสำหรับผมที่แข็งกระด้าง (Hardened Hair Perm Method)',
      quickLayerSearch: 'ตัดเลเยอร์ผมหนา (Thick hair layer cut)',
      quickBobSearch: 'Bob (บ๊อบ) แกรดูเอชั่น',
      canvasTitle: 'Solution Canvas',
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b> คือ<br>AI ที่มีความเชี่ยวชาญในสูตรการตัด/ดัด และทฤษฎีเกี่ยวกับเส้นผม<br><br>💡 <b>วิธีใช้ให้เกิดประโยชน์สูงสุด!</b><br><br><b>1) อัปโหลดรูปภาพสไตล์</b><br>อัปโหลดสไตล์ที่คุณต้องการเรียนรู้และฝึกฝนด้วยสูตร<br><span style="color:#888">ตัวอย่าง: อัปโหลดรูป Hush Cut → รับสูตรเฉพาะ</span><br><br><b>2) ถามทฤษฎี/หลักการ</b><br>ฝึกอธิบายทรีทเมนต์ในรูปแบบ ทำไม→อย่างไร→ผลลัพธ์<br><span style="color:#888">ตัวอย่าง: "โคนผมแบนเนื่องจากรูปศีรษะ(ทำไม)<br>การดัดผมที่โคนผมจะเพิ่มวอลลุ่ม(อย่างไร) สร้างเงาเป็นรูปวงรี(ผลลัพธ์)"</span><br><br>การอธิบายด้วยเหตุผลทางวิทยาศาสตร์ให้ลูกค้า<br>จะเพิ่มความไว้วางใจในตัวคุณ<br><br><span style="color:#888; font-style:italic">"ที่เดียวที่ Success(S) มาก่อน Work(W) คือในพจนานุกรม"<br>- Vidal Sassoon</span>',
      ...
      retentionNotice: '💡 แชทจะถูกเก็บไว้เป็นเวลา 7 วัน',
      deleteConfirm: 'ต้องการลบบทสนทนานี้หรือไม่?',
      history: 'ประวัติ',
      deleteChat: 'ลบแชท',
      ...
      noHistoryDesc: 'วิเคราะห์รูปภาพและจะถูกบันทึกไว้ที่นี่',
      historyRetention: '💡 ประวัติการแชทจะถูกเก็บไว้สูงสุด 7 วัน',
      chatCleared: 'แชทถูกล้างแล้ว',
      enterNewQuestion: 'กรุณาใส่คำถามใหม่',
      confirmClear: 'ลบประวัติการแชททั้งหมด?\n(ประวัติจะถูกลบด้วย)',
      actionRecipe: 'ดูสูตร',
      actionQuestion: 'ถามคำถาม',
      viewPermRecipe: '🌀 ดูสูตร Perm (การดัด) สำหรับทรงนี้',
      viewCutRecipe: '✂️ ดูสูตร Cut (การตัด) สำหรับทรงนี้',
      permRecipeHint: 'ตรวจสอบสูตร Perm (การดัด) สำหรับทรงเดียวกัน',
      cutRecipeHint: 'ตรวจสอบสูตร Cut (การตัด) สำหรับทรงเดียวกัน',
      imageQuestionPrompt: 'คุณอยากทราบอะไรเกี่ยวกับรูปภาพนี้? กรุณาใส่คำถามของคุณ',
      enterQuestion: 'กรุณาใส่คำถาม',
      // Service selection
      serviceLabel: 'บริการ:',
      serviceCut: 'Cut (ตัด)',
      servicePerm: 'Perm (ดัด)',
      comingSoon: '(เร็วๆ นี้)',
      // Category selection
      selectLength: 'เลือกระดับความยาว:',
      selectStyle: 'เลือกสไตล์:',
      // Female length categories
      catFemaleH: 'H - สั้น',
      catFemaleHPos: 'ด้านหลังศีรษะ/ท้ายทอย',
      catFemaleHDesc: 'ผมสั้น ทรง Pixie Cut, ทรงสั้นมาก',
      catFemaleG: 'G - Bob (เหนือคาง)',
      catFemaleGPos: 'เหนือแนวคาง',
      catFemaleGDesc: 'Bob (บ๊อบ) สั้นเหนือคาง โชว์ใบหน้ามากขึ้น',
      catFemaleF: 'F - Bob (ใต้คาง)',
      catFemaleFPos: 'ใต้แนวคาง',
      catFemaleFDesc: 'ความยาว Bob (บ๊อบ) ใต้คางถึงคอ Bob (บ๊อบ) สไตล์คลาสสิก',
      catFemaleE: 'E - ปานกลาง (เหนือไหล่)',
      catFemaleEPos: 'เหนือไหล่',
      catFemaleEDesc: 'สั้นกว่าความยาวระดับไหล่เล็กน้อย ทรงปานกลางเรียบร้อย',
      catFemaleD: 'D - ปานกลาง (ไหล่)',
      catFemaleDPos: 'ระดับไหล่',
      catFemaleDDesc: 'ความยาวสัมผัสไหล่ อาจจะงอนออก',
      catFemaleC: 'C - กึ่งยาว (ใต้กระดูกไหปลาร้า)',
      catFemaleCPos: 'รักแร้/หน้าอกส่วนบน',
      catFemaleCDesc: 'ระหว่างรักแร้และหน้าอกส่วนบน ความยาวหลากหลาย',
      catFemaleB: 'B - ยาว (หน้าอก)',
      catFemaleBPos: 'กลางหน้าอก',
      catFemaleBDesc: 'ผมยาวถึงกลางหน้าอก ความยาวที่ได้รับความนิยมมากที่สุด',
      catFemaleA: 'A - ยาว (ใต้หน้าอก)',
      catFemaleAPos: 'ใต้หน้าอก/เอว',
      catFemaleADesc: 'ความยาวที่ยาวที่สุด ถึงเอว',
      // Male style categories
      catMaleSF: 'Side Fringe (หน้าม้าปัดข้าง)',
      catMaleSP: 'Side Part (แสกข้าง)',
      catMaleFU: 'Fringe Up (หน้าม้าตั้งขึ้น)',
      catMalePB: 'Pushed Back (เสยไปด้านหลัง)',
      catMaleBZ: 'Buzz Cut (บัตซ์คัต)',
      catMaleCP: 'Crop (ทรงครอป)',
      catMaleMC: 'Mohican (โมฮิกัน)',
      // Alert messages
      onlyImageFiles: 'สามารถอัปโหลดได้เฉพาะไฟล์รูปภาพเท่านั้น',
      imageSizeLimit5MB: 'ขนาดรูปภาพต้องไม่เกิน 5MB',
      imageSizeLimit10MB: 'ขนาดรูปภาพต้องไม่เกิน 10MB',
      selectStyleAlert: 'กรุณาเลือกทรงผม',
      selectGenderAlert: 'กรุณาเลือกเพศ',
      selectLengthAndForm: 'กรุณาเลือกระดับความยาวและรูปแบบทรงผม',
      selectLengthAndPermType: 'กรุณาเลือกระดับความยาวและประเภทของการดัด (Perm)',
      noImageData: 'ไม่มีข้อมูลรูปภาพสำหรับการวิเคราะห์ใหม่ กรุณาอัปโหลดรูปภาพอีกครั้ง',
      reanalysisError: 'เกิดข้อผิดพลาดระหว่างการวิเคราะห์ใหม่',
      permReanalysisError: 'เกิดข้อผิดพลาดระหว่างการวิเคราะห์การดัด (Perm) ใหม่',
      noStyleInfo: 'ไม่มีข้อมูลทรงผม',
      permRecipeError: 'เกิดข้อผิดพลาดในการดึงสูตรการดัด (Perm)',
      cutRecipeError: 'เกิดข้อผิดพลาดในการดึงสูตรการตัด',
      malePermComingSoon: 'สูตรการดัด (Perm) สำหรับผู้ชายจะมาเร็วๆ นี้',
      selectCategoryFormat: 'กรุณาเลือก',
      deleteFailed: 'ลบไม่สำเร็จ',
      saveComingSoon: 'ฟีเจอร์บันทึกจะมาเร็วๆ นี้',
      shareNotSupported: 'เบราว์เซอร์นี้ไม่รองรับฟีเจอร์แชร์',
      deleteConfirm: 'ต้องการลบบทสนทนานี้หรือไม่?',
    ...
    hairTry: {
      button: 'ลองทรงผม',
      title: 'ลองทรงผม',
      subtitle: 'ลองทรงผมใหม่ด้วย AI',
      uploadPhoto: 'อัปโหลดรูปภาพ',
      takePhoto: 'ถ่ายด้วยกล้อง',
      or: 'หรือ',
      selectFromGallery: 'เลือกจากแกลเลอรี',
      selectedStyle: 'ทรงผมที่เลือก',
      styleToApply: 'ทรงผมที่จะใช้',
      changePhoto: 'เปลี่ยนรูปภาพ',
      startButton: 'เริ่มลองทรงผม',
      processing: 'AI กำลังปรับใช้ทรงผม...',
      processingSubtext: 'โปรดรอผลลัพธ์ที่ดีที่สุด',
      result: 'ผลลัพธ์การลอง',
      retry: 'ลองใหม่',
      save: 'บันทึก (Save)',
      share: 'แชร์',
      noCredits: 'เครดิตไม่เพียงพอ',
      insufficientCredits: 'เครดิตไม่เพียงพอ โปรดเติมเงินเพื่อดำเนินการต่อ',
      confirmTitle: 'ประกาศการหัก Token',
      confirmMessage: 'โทเค็นจะถูกหักสำหรับการใช้ Hair Try\nคุณต้องการดำเนินการต่อหรือไม่?',
      confirmButton: 'ตกลง',
      cancelButton: 'ยกเลิก',
      photoGuide: 'การใช้รูปภาพที่ถ่ายจากด้านหน้าจะให้ผลลัพธ์ที่แม่นยำยิ่งขึ้น',
      error: 'เกิดข้อผิดพลาด กรุณาลองอีกครั้ง',
      disclaimer: 'นี่คือผลลัพธ์เสมือนจริง โปรดใช้เพื่ออ้างอิงเพื่อให้ได้ความรู้สึกของทรงผมเท่านั้น ผลลัพธ์จริงอาจแตกต่างกันไป',
      before: 'ก่อน',
      after: 'หลัง',
      style: 'สไตล์ (STYLE)',
      saved: 'บันทึกรูปภาพสำเร็จ',
      saveError: 'เกิดข้อผิดพลาดในการบันทึกรูปภาพ',
      saveManual: 'กดค้างที่รูปภาพในแท็บใหม่เพื่อบันทึก',
      saveGuide: 'กดค้างที่รูปภาพเพื่อบันทึก',
      modalError: 'ไม่สามารถเปิดหน้าต่าง Modal ได้',
      analysisError: 'เกิดข้อผิดพลาดระหว่างการวิเคราะห์ กรุณาลองใหม่อีกครั้ง',
      cameraError: 'ไม่สามารถเข้าถึงกล้องได้ โปรดตรวจสอบการอนุญาต',
      photoTaken: 'ถ่ายภาพแล้ว',
      imageOnly: 'สามารถอัปโหลดได้เฉพาะไฟล์รูปภาพเท่านั้น',
      fileSizeLimit: 'ขนาดไฟล์จำกัดไว้ที่ 10MB',
      readError: 'เกิดข้อผิดพลาดขณะอ่านรูปภาพ',
      processingProgress: 'กำลังประมวลผลด้วย AI... ({n}/{total})',
      cannotSave: 'ไม่สามารถบันทึกรูปภาพได้'
    },
    ...
    lookbook: {
      ...
      insufficientCredits: 'เครดิตไม่เพียงพอ โปรดเติมเงินเพื่อดำเนินการต่อ',
      confirmTitle: 'ประกาศการหัก Token',
      confirmMessage: 'ระบบจะหัก Token เมื่อใช้ Lookbook\nคุณต้องการดำเนินการต่อหรือไม่?',
      confirmButton: 'ตกลง',
      cancelButton: 'ยกเลิก',
      loading: 'AI กำลังวิเคราะห์สไตล์ของคุณ...',
      loadingSubtext: 'AI กำลังสร้างหน้ารายละเอียด Lookbook สำหรับสไตล์นี้',
      theEdit: 'THE EDIT',
      createNew: 'สร้าง Look ใหม่',
      close: 'ปิด',
      trendReport: 'รายงานเทรนด์ปี 2025',
      analysis: 'การวิเคราะห์',
      variations: 'การจับคู่แฟชั่น',
      faceShape: 'รูปหน้าแนะนำ',
      styleLook: 'จัดสไตล์ลุค',
      ...
      tags: {
        vintage: '#วินเทจ',
        bohemian: '#โบฮีเมียน',
        volume: '#มีวอลลุ่ม (Volume)',
        lovely: '#น่ารัก'
      },
      descriptions: {
        main: 'เปิดรับความวุ่นวาย สไตล์นี้จะนำจิตวิญญาณแห่งความอิสระและโบฮีเมียนมาสู่การจัดแต่งทรงผมที่ทันสมัย ไม่ใช่แค่ทรงผม แต่เป็นทัศนคติ',
        faceShape: '**วอลลุ่มด้านข้างที่เยอะ** ของสไตล์นี้ช่วยเสริมโครงหน้าเรียวของใบหน้ารูปหัวใจ สร้างความสมดุล พร้อมทั้งเพิ่มข้อดีของใบหน้ารูปไข่โดยเน้นรูปทรงที่อ่อนโยน',
        maintenance: 'ความงามของสไตล์นี้อยู่ที่ **การดูแลรักษาที่ง่าย** ยิ่งยุ่งเหยิงยิ่งดี อย่างไรก็ตาม ความชุ่มชื้นเป็นสิ่งสำคัญในการป้องกันไม่ให้ผมดูเหมือนฟาง'
      },
      styleVariations: {
        chic: 'ความเก๋แบบมีโครงสร้าง (The Chic Structured)',
        chicDesc: 'ตัดกับวอลลุ่มด้วยการตัดเย็บที่เฉียบคม',
        boho: 'โบโฮแมนติก (The Romantic Boho)',
        bohoDesc: 'ผ้านุ่มสำหรับสุนทรียภาพชวนฝัน',
        casual: 'ลำลองในชีวิตประจำวัน (The Daily Casual)',
        casualDesc: 'ให้ความรู้สึกสบายๆ ด้วยผ้ายีนส์และเสื้อยืด'
      },
      styling: {
        item1: 'เบลเซอร์ขนาดใหญ่ (Oversized Blazers)',
        desc1: 'ตัดผมที่ดูยุ่งเหยิงให้แตกต่างด้วยเสื้อผ้าที่ตัดเย็บอย่างประณีต',
        item2: 'ชุดเดรสลายดอกไม้',
        desc2: 'อินไปกับสไตล์คอทเทจคอร์',
        item3: 'ต่างหูโดดเด่น',
        desc3: 'ห่วงทองคำจะดูจมหายไป เลือกต่างหูแบบหนาที่เห็นได้ชัดเจน'
      }
    },
    ...
    recipe: {
      button: 'สูตร',
      selectType: 'เลือกประเภทสูตร',
      cutRecipe: 'สูตรการตัด (Cut Recipe)',
      permRecipe: 'สูตรการดัด (Perm Recipe) - สูตรสำหรับทำผม Perm',
      loading: 'กำลังโหลดสูตร...'
    },

    // ========== AI Style Match ==========
    styleMatch: {
      menuTitle: 'จับคู่สไตล์ด้วย AI',
      menuSubtitle: 'วิเคราะห์รูปหน้า',
      uploadTitle: 'วิเคราะห์รูปถ่ายใบหน้า',
      uploadText: 'อัปโหลดรูปภาพของคุณ',
      uploadHint: 'รูปภาพที่ถ่ายจากด้านหน้าจะได้ผลลัพธ์ดีที่สุด',
      cameraMode: 'กล้องสด',
      uploadMode: 'อัปโหลดรูปภาพ',
      cameraHint: 'มองตรงไปข้างหน้า',
      faceDetected: 'ตรวจพบใบหน้า',
      selectGender: 'เลือกเพศ',
      female: 'หญิง (Female)',
      male: 'ชาย (Male)',
      startAnalysis: 'เริ่มการวิเคราะห์',
      analyzing: 'กำลังวิเคราะห์ใบหน้าของคุณ...',
      analysisTitle: 'ผลการวิเคราะห์ใบหน้า',
      faceMetrics: 'Face Ratio Analysis (เฟซ เรโช อนาลิซิส - การวิเคราะห์อัตราส่วนใบหน้า)',
      upperFace: 'ใบหน้าส่วนบน',
      middleFace: 'ใบหน้าส่วนกลาง',
      lowerFace: 'ใบหน้าส่วนล่าง',
      faceWidth: 'ความกว้างของใบหน้า',
      jawWidth: 'ความกว้างของกราม',
      cheekJawRatio: 'อัตราส่วนแก้ม/กราม',
      analysisSummary: 'สรุปผลการวิเคราะห์',
      recommendations: 'สไตล์ที่แนะนำ',
      noFaceDetected: 'ไม่สามารถตรวจจับใบหน้าได้ โปรดใช้รูปภาพที่ถ่ายจากด้านหน้า',
      bangsStyle: 'ผมหน้าม้า (bangs)',
      generalRecommendation: 'สไตล์พื้นฐานที่แนะนำ',
      summaryDefault: 'คุณมีรูปหน้าที่สมดุลซึ่งเหมาะกับหลายสไตล์',
      tryOn: 'ลองใส่',
      viewLookbook: 'ดู Lookbook',
      imageType: 'ประเภทรูปภาพ',
      eyebrowType: 'ประเภทคิ้ว',
      eyebrowArch: 'ความโค้งของคิ้ว',
      eyebrowThickness: 'ความหนาของคิ้ว',
      eyebrowDensity: 'ความหนาแน่นของคิ้ว',
      eyebrowTail: 'ปลายคิ้ว',
      alertFaceNotDetected: 'ไม่สามารถตรวจจับใบหน้าได้ โปรดหันหน้าเข้าหากล้องโดยตรง',
      alertAnalysisError: 'เกิดข้อผิดพลาดระหว่างการวิเคราะห์',
      alertSelectPrescription: 'โปรดเลือกค่าที่กำหนดไว้',
      faceType: {
        oval: 'รูปไข่ (Oval)',
        square: 'สี่เหลี่ยม',
        heart: 'รูปหัวใจ',
      ...
      insight: {
        wideForehead: 'ช่วงบนของใบหน้ากว้างกว่าค่าเฉลี่ย (33%)',
        narrowForehead: 'ช่วงบนของใบหน้าแคบกว่าค่าเฉลี่ย',
        longFace: 'ช่วงล่างของใบหน้ายาวกว่าช่วงกลางของใบหน้ามากกว่า 15%',
        shortFace: 'ช่วงล่างของใบหน้าสั้นกว่าช่วงกลางของใบหน้า',
        squareJaw: 'ความกว้างของโหนกแก้มและความกว้างของกรามใกล้เคียงกัน',
        ovalFace: 'คุณมีรูปหน้าวงรีที่สมบูรณ์แบบ',
        heartFace: 'คุณมีรูปหน้าหัวใจ/สามเหลี่ยมคว่ำ'
      },
      issue: {
        wideForehead: 'หน้าผากกว้าง',
        narrowForehead: 'หน้าผากแคบ',
        longFace: 'หน้ารูปยาว',
        shortFace: 'หน้ารูปสั้น',
        squareJaw: 'กรามเป็นเหลี่ยม',
        heartFace: 'คางแคบ'
      },
      solution: {
        wideForehead: 'ผมหน้าม้าที่ปิดหน้าผากโดยธรรมชาติเหมาะกับคุณ',
        narrowForehead: 'การเปิดหน้าผากหรือผมหน้าม้าที่เพิ่มวอลลุ่ม (Volume) เหมาะกับคุณ',
        longFace: 'ทรงผมที่มีวอลลุ่ม (Volume) ในแนวนอนเพื่อปรับสมดุลความยาวเหมาะกับคุณ',
        shortFace: 'ทรงผมที่ยาวขึ้นซึ่งเพิ่มความยาวในแนวตั้งเหมาะกับคุณ',
        squareJaw: 'ผมลอนคลาย (Soft waves) สามารถลดความแข็งของใบหน้าได้',
        ovalFace: 'ทรงผมส่วนใหญ่จะเหมาะกับคุณ',
        heartFace: 'ทรงผมที่มีวอลลุ่ม (Volume) บริเวณคางเหมาะกับคุณ'
      },
      reason: {
        bangsCover: 'ผมหน้าม้าปิดหน้าผาก',
        foreheadExposed: 'การเปิดหน้าผากทั้งหมดทำให้ดูหน้าผากกว้างขึ้น',
        foreheadOpen: 'การเปิดหน้าผากสร้างความสมดุล',
        horizontalVolume: 'วอลลุ่ม (Volume) ในแนวนอนเพื่อความสมดุล',
        verticalLonger: 'ทำให้ดูยาวขึ้นในแนวตั้ง',
        sideVolume: 'วอลลุ่ม (Volume) ด้านข้างเพื่อความสมดุล',
        verticalExtend: 'เพิ่มเส้นแนวตั้ง',
        topVolume: 'วอลลุ่ม (Volume) ด้านบนเพิ่มความสูง',
        softWave: 'ผมลอนคลาย (Soft waves) ช่วยเสริมแนวกราม',
        jawExposed: 'แนวกรามถูกเน้น',
        sideSoftening: 'วอลลุ่ม (Volume) ด้านข้างช่วยลดความแข็งของแนวกราม',
        angularEmphasized: 'เน้นความแข็งของใบหน้า',
        idealShape: 'รูปหน้าที่สมบูรณ์แบบ',
        chinVolume: 'วอลลุ่ม (Volume) บริเวณคางเพื่อความสมดุล',
        foreheadBalance: 'การปรับวอลลุ่ม (Volume) หน้าผากเพื่อความสมดุล',
        longFaceHorizontal: 'วอลลุ่ม (Volume) แนวนอนช่วยปรับสมดุลสัดส่วนแนวตั้ง',
        longFaceWave: 'ผมยาว + ลอน (Waves) สร้างวอลลุ่ม (Volume) แนวนอน',
        longFaceStraightAvoid: 'ผมยาวตรงทำให้ใบหน้าดูยาวขึ้น',
        longFaceSideVolume: 'วอลลุ่ม (Volume) ด้านข้างช่วยกระจายความยาวของใบหน้า',
        longFaceTopVolumeAvoid: 'วอลลุ่ม (Volume) ด้านบนทำให้ใบหน้าดูยาวขึ้น',
        shortFaceLongLength: 'ผมยาวเพิ่มเส้นแนวตั้ง',
        shortFaceTopVolume: 'วอลลุ่ม (Volume) ด้านบนทำให้ใบหน้าดูเรียวขึ้น',
        archEyebrowCurve: 'ช่วยเสริมส่วนโค้งของคิ้วที่โค้งตามธรรมชาติ',
        archEyebrowSoftCover: 'ปิดส่วนโค้งของคิ้วเบาๆ เพื่อให้ดูอ่อนโยน',
        straightEyebrowShow: 'แสดงให้เห็นคิ้วตรงเพื่อความประทับใจที่ดูเท่',
        straightEyebrowHideAvoid: 'การซ่อนคิ้วทำให้สูญเสียความงามแบบเส้นตรง',
        straightEyebrowChic: 'คิ้วตรงสร้างลุคที่เก๋ไก๋',
        thickEyebrowShow: 'เผยคิ้วที่โดดเด่นเพื่อลุคที่มีเสน่ห์',
        thinEyebrowNatural: 'สไตล์ธรรมชาติเข้ากับคิ้วบาง',
        thinEyebrowSoft: 'ผมหน้า(Bangs) สร้างความประทับใจที่อ่อนโยน',
        longFaceSideBalance: 'วอลลุ่มด้านข้าง(Side volume) สร้างสมดุลให้กับความยาว',
        roundFaceSideDown: 'ทำให้ด้านข้างแบนเพื่อเอฟเฟกต์ที่ยาวขึ้น',
    ...
    // ========== AI Face Transform ==========
    aiTransform: {
      menuTitle: 'AI Face Transform (แปลงใบหน้าด้วย AI)',
      menuSubtitle: 'สลับใบหน้า (Face Swap) · เสื้อผ้า/พื้นหลัง',
      headerTitle: 'AI Face Transform (แปลงใบหน้าด้วย AI)',
      faceSwapTitle: 'AI Face Transform (แปลงใบหน้าด้วย AI)',
      faceSwapDesc: 'รักษารูปแบบทรงผมเดิมและเปลี่ยนเฉพาะใบหน้า',
      hairstylePhoto: 'รูปถ่ายทรงผม (Hairstyle Photo)',
      original: 'ต้นฉบับ (Original)',
      referenceFace: 'ใบหน้าอ้างอิง (Reference Face)',
      face: 'ใบหน้า (Face)',
      changeClothing: 'เปลี่ยนเสื้อผ้า (Change Clothing)',
      changeBackground: 'เปลี่ยนพื้นหลัง (Change Background)',
      noChange: 'ไม่เปลี่ยนแปลง (No Change)',
      male: 'ชาย (Male)',
      female: 'หญิง (Female)',
      clothing: {
        navySuit: 'ชุดสูทสีกรมท่า (Navy Suit)',
        whiteTshirt: 'เสื้อยืดสีขาว (White T-shirt)',
        blackTurtleneck: 'เสื้อคอเต่าสีดำ (Black Turtleneck)',
        blueShirt: 'เสื้อเชิ้ตสีฟ้าอ่อน (Light Blue Shirt)',
        grayBlazer: 'เสื้อเบลเซอร์สีเทา (Gray Blazer)',
        blackDress: 'ชุดเดรสสีดำ (Black Dress)',
        whiteBlouse: 'เสื้อเบลาส์สีขาว (White Blouse)',
        navyJacket: 'เสื้อแจ็คเก็ตสีกรมท่า (Navy Jacket)',
        pinkKnit: 'เสื้อถักสีชมพู (Pink Knit)',
        creamCardigan: 'เสื้อคาร์ดิแกนสีครีม (Cream Cardigan)'
      },
      background: {
        whiteStudio: 'สตูดิโอสีขาว (White Studio)',
        grayStudio: 'สตูดิโอสีเทา (Gray Studio)',
        gradient: 'การไล่ระดับสี (Gradient)',
        cementWall: 'กำแพงปูน (Cement Wall)',
        woodenWall: 'กำแพงไม้ (Wooden Wall)',
        bokeh: 'โบเก้เบลอ (Bokeh Blur)'
      },
      startFaceSwap: 'เริ่มสลับใบหน้า (Start Face Swap)',
      tokens: 'โทเค็น (Tokens)',
      save: 'บันทึก (Save)',
      tryAgain: 'ลองอีกครั้ง (Try Again)',
      processing: 'กำลังดำเนินการ... (Processing...)',
      selectImage: 'เลือกรูปภาพ (Select Image)',
      result: 'ผลลัพธ์ (Result)',
      pleaseWait: 'โปรดรอสักครู่... (Please wait...)',
      freePlanTitle: 'คุณสมบัติแผนชำระเงิน (Paid Plan Feature)',
      freePlanDesc: 'AI เปลี่ยนใบหน้า (AI Face Transform) สามารถใช้ได้สำหรับแผน Basic ขึ้นไป',
      upgradePlan: 'อัปเกรดแผน',
      goBack: 'ย้อนกลับ'
    },
    ...
    personalColor: {
      title: 'HAIRGATOR Personal Color',
      subtitle: 'ระบบวิเคราะห์ Personal Color ด้วย AI',
      ...
      // Loading screen
      loadingSteps: {
        hairColorData: 'Loading hair color data... (กำลังโหลดข้อมูลสีผม...)',
        uiSetup: 'กำลังตั้งค่าส่วนประกอบ UI...',
        aiEngine: 'กำลังเตรียมเอ็นจินการจดจำใบหน้า AI...',
        ready: 'ระบบพร้อมใช้งาน!',
        readyToast: 'ระบบ Personal Color พร้อมใช้งาน!',
        partialError: 'คุณสมบัติบางอย่างอาจถูกจำกัด'
      },

      mainMenu: {
        aiAnalysis: 'วิเคราะห์ Personal Color ด้วย AI',
        aiAnalysisDesc: 'วิเคราะห์สีผิวแบบเรียลไทม์ด้วยกล้อง',
        draping: 'Expert Draping (การเทียบสีโดยผู้เชี่ยวชาญ)',
        drapingDesc: 'เปรียบเทียบกับสี 4 ฤดูกาล'
      },

      aiMode: {
        title: 'วิเคราะห์ Personal Color ด้วย AI',
        backHome: '← หน้าแรก',
        startCamera: '📹 เริ่มกล้อง',
        capture: '📸 จับภาพ',
        retry: '🔄 ลองใหม่',
        faceGuide: 'จัดตำแหน่งใบหน้าของคุณ<br>ให้อยู่ตรงกลาง',
        captureGuide: '✨ ตรวจพบใบหน้า! กดปุ่ม <b>จับภาพ</b>',
        faceDetected: 'ตรวจพบใบหน้า! กดปุ่มจับภาพ',
        captureComplete: 'จับภาพเสร็จสมบูรณ์! ตรวจสอบผลลัพธ์ของคุณ',
        retryMessage: 'โปรดจัดตำแหน่งใบหน้าของคุณอีกครั้ง',
        description: 'AI วิเคราะห์สีผิวของคุณแบบเรียลไทม์ผ่านกล้อง\nเพื่อให้ได้ผลลัพธ์ที่แม่นยำ ให้ใช้ใบหน้าที่เปลือยเปล่าโดยไม่แต่งหน้าในแสงธรรมชาติ',
        feature1: 'การตรวจจับใบหน้าแบบเรียลไทม์และการดึงสีผิว',
        feature2: 'การวิเคราะห์ที่แม่นยำตามปริภูมิสี LAB',
        feature3: 'การใช้ฐานข้อมูลความรู้ของผู้เชี่ยวชาญ',
        feature4: 'จับคู่สีผมอัตโนมัติกับ 624 สี',
        startBtn: 'เริ่มการวิเคราะห์ AI',
        ...
        steps: {
          ...
          step2Desc: 'การแปลงปริภูมิสี RGB เป็น LAB',
          step3: 'การคำนวณ Delta E',
          step3Desc: 'การวัดความแตกต่างของสี',
          step4: 'การสร้างผลลัพธ์',
          step4Desc: 'การวินิจฉัยขั้นสุดท้ายโดยผู้เชี่ยวชาญ',
          titleCompact: 'ความคืบหน้าการวิเคราะห์ AI',
          analyzingSkinTone: 'กำลังวิเคราะห์สีผิว...'
        },
        takePhoto: 'ถ่ายรูป',
        takePhotoDesc: 'เริ่มกล้องทางด้านซ้ายและจับภาพใบหน้าของคุณเพื่อการวิเคราะห์ AI',
        customerSummary: 'สรุปการวิเคราะห์ลูกค้า',

        result: {
          title: '🎨 ผลการวิเคราะห์ Personal Color',
          skinAnalysis: '📍 การวิเคราะห์ผิวของคุณ',
          skinTone: 'สีผิว',
          undertone: 'Undertone (โทนสีผิว)',
          recommendedSeason: '✨ สี Personal Color ที่แนะนำ',
          avoidColors: 'สีที่ควรหลีกเลี่ยง',
          lighting: 'Lighting (แสง)',
          treatmentRecipe: 'Treatment Recipe (ทรีตเมนต์ เรซิพี - สูตรทรีตเมนต์)',
          hairColorRecommend: 'Hair Color Recommendation (แฮร์ คัลเลอร์ เรคคอมเมนเดชั่น - สีผมที่แนะนำ)',
          expertGuide: 'Expert Guide (เอ็กซ์เพิร์ท ไกด์ - คำแนะนำจากผู้เชี่ยวชาญ)',
          treatmentDifficulty: 'Treatment Difficulty (ทรีตเมนต์ ดิฟฟิคัลตี้ - ความยากในการทำทรีตเมนต์)',
          lightingHigh: 'ดี',
          lightingMedium: 'ปานกลาง',
          lightingLow: 'Low (Reference) (ต่ำ (อ้างอิง))',
          treatmentPoints: 'Treatment Points (ทรีตเมนต์ พอยท์ - จุดสำคัญในการทำทรีตเมนต์)',
          expertAnalysis: 'Expert Analysis (เอ็กซ์เพิร์ท อนาลิซิส - การวิเคราะห์โดยผู้เชี่ยวชาญ)',
          matchingColors: '💄 Makeup & Fashion Colors (เมคอัพ แอนด์ แฟชั่น คัลเลอร์ - สีสำหรับการแต่งหน้าและแฟชั่น)',
          confidence: 'Confidence (ความมั่นใจ)',
          customStyleRecommend: '💇 Custom Style Recommendation (คัสตอม สไตล์ เรคคอมเมนเดชั่น - ทรงผมที่แนะนำเฉพาะบุคคล)',
          fringeCombo: 'fringe combination (ฟรินจ์ คอมบิเนชั่น - ทรงผมหน้าม้าที่เข้ากัน)',
          seasonColorHarmony: 'Hair color harmonizing with season color (สีผมที่เข้ากับสีประจำฤดูกาล)',
          faceShapeAnalysis: '📐 Face Shape Analysis (เฟซ เชพ อนาลิซิส - การวิเคราะห์รูปหน้า)',
          faceRatio: 'สัดส่วนใบหน้า',
          eyeDistance: 'ระยะห่างระหว่างดวงตา',
          recommendedHairColor: '💇 Recommended Hair Color (แฮร์ คัลเลอร์ เรคคอมเมนเดชั่น - สีผมที่แนะนำ)',
          recommendedHairColor1st: '💇 Recommended Hair Color (1st) (แฮร์ คัลเลอร์ เรคคอมเมนเดชั่น (1) - สีผมที่แนะนำ (1))',
          recommendedHairColor2nd: '💇 Recommended Hair Color (2nd) (แฮร์ คัลเลอร์ เรคคอมเมนเดชั่น (2) - สีผมที่แนะนำ (2))',
          highlyRecommended: 'Highly Recommended (แนะนำเป็นอย่างยิ่ง)',
          safeChoice: 'Safe Choice (ตัวเลือกที่ปลอดภัย)',
          loadingColors: 'Loading hair color data... (กำลังโหลดข้อมูลสีผม...)',
          aiHairConsultantReport: '📋 AI Hair Consultant Report (เอไอ แฮร์ คอนซัลแทนท์ รีพอร์ต - รายงานจาก AI ที่ปรึกษาด้านทรงผม)',
          sectionAPreciseDiagnosis: '🔬 SECTION A: Precise Diagnosis (เซคชั่น เอ: การวินิจฉัยที่แม่นยำ)',
          recommendedLevel: '📊 ระดับที่แนะนำ',
          sectionBColorScience: '🧬 SECTION B: Color Science (เซคชั่น บี: วิทยาศาสตร์แห่งสี)',
          melaninAnalysis: 'Melanin Analysis (เมลานิน อนาลิซิส - การวิเคราะห์เมลานิน)',
          undercoatPrediction: 'Undercoat Prediction (อันเดอร์โค้ท พรีดิคชั่น - การคาดการณ์สีพื้นผม)',
          neutralizationStrategy: 'Neutralization Strategy (นิวทรัลไลเซชั่น สแตรทิจี - กลยุทธ์การหักล้างสี)',
          sectionCTreatmentRecipe: '💊 SECTION C: Treatment Recipe (เซคชั่น ซี: ทรีตเมนต์ เรซิพี - สูตรทรีตเมนต์)',
          treatmentTips: '✂️ Treatment Tips (ทรีตเมนต์ ทิปส์ - เคล็ดลับในการทำทรีตเมนต์)',
          undercoat: 'Undercoat (สีชั้นใน)',
          finishTexture: 'Finish Texture (ลักษณะพื้นผิวสุดท้าย)',
          totalBeauty: '💄 Total Beauty (โททัล บิวตี้ - ความงามโดยรวม)',
          fashion: 'Fashion (แฟชั่น)',
          makeup: 'Makeup (เมคอัพ)',
          consultingPoint: '💬 Consulting Point (คอนซัลติ้ง พอยท์ - ประเด็นในการปรึกษา)',
          score: 'pts',
          close: 'ปิด',
          // Additional analysis result keys
          difficulty: 'Difficulty (ความยาก)',
          minute: 'min (นาที)',
          faceRatioAnalysis: 'Face Ratio Analysis (เฟซ เรโช อนาลิซิส - การวิเคราะห์อัตราส่วนใบหน้า)',
          eyebrowGapDistance: 'Eyebrow Gap Distance (อายบราว แก๊ป ดิสแทนซ์ - ระยะห่างระหว่างคิ้ว)',
          eyeToEyeRatio: 'Eye:Gap Ratio (1.0 = Ideal) (อาย:แก๊ป เรโช (1.0 = เหมาะสม))',
          narrow: 'Narrow (แคบ)',
          optimal: 'เหมาะสมที่สุด',
          wide: 'กว้าง',
          currentEyebrowKeep: 'แนะนำให้คงรูปทรงคิ้วเดิม',
          eyebrowNarrowTip: 'เล็มคิ้วด้านในเพื่อให้ดูสดชื่นขึ้น',
          eyebrowWideTip: 'เติมคิ้วด้านในเพื่อให้ได้รูปทรงที่ชัดเจน',
          faceRatioLabel: 'สัดส่วนใบหน้า',
          eyeDistance: 'ระยะห่างระหว่างดวงตา',
          // Curl recommendation text
          curlStraightDesc: 'ทรงผมตรงเพื่อภาพลักษณ์ที่เรียบร้อย',
          curlCDesc: 'C-curl เพื่อวอลลุ่มที่เป็นธรรมชาติและให้ความรู้สึกเป็นผู้หญิง (C-curl: ลอนตัวซี)',
          curlSDesc: 'S-curl เพื่อลอนผมที่สวยงามและสไตล์ที่หรูหรา (S-curl: ลอนตัวเอส)',
          curlCSDesc: 'ผสม C+S curl เพื่อลุคที่มีมิติและซับซ้อน (C+S curl: ผสมลอนตัวซีและเอส)',
          curlSSDesc: 'SS-curl เพื่อลอนที่แข็งแรงและบุคลิกที่เป็นเอกลักษณ์ (SS-curl: ลอนตัวเอสสองชั้น)',
          curlNoneDesc: 'มีรูปแบบลอนต่างๆ ให้เลือกตามความชอบ',
          // Season name
          neutralWarmDeep: 'กลาง โทนอุ่น โทนเข้ม',
          // Season base names
          springWarm: 'Spring Warm (ฤดูใบไม้ผลิ โทนอุ่น)',
          autumnWarm: 'Autumn Warm (ฤดูใบไม้ร่วง โทนอุ่น)',
          summerCool: 'Summer Cool (ฤดูร้อน โทนเย็น)',
          winterCool: 'Winter Cool (ฤดูหนาว โทนเย็น)',
          neutralWarm: 'กลาง โทนอุ่น',
          neutralCool: 'กลาง โทนเย็น',
          neutral: 'กลาง',
          // Subtypes
          bright: 'สดใส',
          light: 'อ่อน',
          ...
          // Season descriptions
          seasonDesc: {
            springWarmBright: 'ภาพลักษณ์ที่สดใสและเปล่งปลั่ง! สีโทนอุ่นที่สดใสและชัดเจนเหมาะกับคุณที่สุด',
            springWarmLight: 'ภาพลักษณ์ที่สดใหม่และบริสุทธิ์! สีโทนอุ่นอ่อนๆ เหมาะกับคุณที่สุด',
            autumnWarmDeep: 'ภาพลักษณ์ที่เข้มข้นและหรูหรา! สีโทนอุ่นเข้มข้นเหมาะกับคุณที่สุด',
            autumnWarmMuted: 'ภาพลักษณ์ที่เป็นธรรมชาติและซับซ้อน! สีโทนอุ่นที่เป็นธรรมชาติและสงบเหมาะกับคุณที่สุด',
            autumnWarmSoft: 'ภาพลักษณ์ที่อ่อนโยนและอบอุ่น! สีโทนอุ่นที่เป็นธรรมชาติและละเอียดอ่อนเหมาะกับคุณที่สุด',
            summerCoolBright: 'ภาพลักษณ์ที่สดใสและสดชื่น! สีโทนเย็นที่สดใสและสะอาดเหมาะกับคุณที่สุด',
            summerCoolLight: 'ภาพลักษณ์ที่สง่างามและอ่อนโยน! สีโทนเย็นพาสเทลเหมาะกับคุณที่สุด',
            winterCoolDeep: 'ภาพลักษณ์ที่โดดเด่นและทันสมัย! สีโทนเย็นเข้มข้นเหมาะกับคุณที่สุด',
            winterCoolMuted: 'ภาพลักษณ์ที่สงบและประณีต! สีโทนเย็นที่ไม่มีสีและมีความอิ่มตัวต่ำเหมาะกับคุณที่สุด',
            neutralLight: 'หลากหลายสไตล์! แนะนำสีโทนสว่างและอ่อน',
            neutralDeep: 'หลากหลายสไตล์! แนะนำสีโทนเข้มและซับซ้อน'
          }
        }
      },

      avoidRules: {
        coolToneWarning: 'สีโทนเย็นเช่นดำน้ำเงินหรือเทาน้ำเงินอาจทำให้ใบหน้าของคุณดูหมองคล้ำ',
        darkLevelWarning: 'สีที่ต่ำกว่าระดับ 3 อาจทำให้ผิวของคุณดูคล้ำขึ้น',
        warmToneWarning: 'สีโทนอุ่นเช่นทอง ส้ม หรือทองแดง อาจทำให้ผิวของคุณดูเหลือง',
        vividRedWarning: 'หลีกเลี่ยงสีแดงหรือส้มที่สดใส',
        neutralRecommend: 'แนะนำสีโทนกลางมากกว่าสีโทนอุ่น/เย็นที่มากเกินไป',
        vividColorWarning: 'สีสดใสที่มีความอิ่มตัวสูงอาจไม่เข้ากับสีผิวของคุณ'
      },

      expertAnalysis: {
        springWarm: 'ผิวสีงาช้างดูดีกับสีเบจคาราเมลหรือน้ำตาลส้ม สีสดใสเหมาะกับคุณที่สุด',
        summerCool: 'การผสมผสานระหว่างความสว่างและความอิ่มตัวมีความสำคัญมากกว่าชื่อสี แนะนำสีพาสเทลอ่อนๆ',
        autumnWarm: 'สีโทนอุ่นเข้มเหมาะอย่างยิ่ง แนะนำสีน้ำตาลเข้ม',
        winterCool: 'ผิวขาวเข้ากันได้ดีกับดำน้ำเงินหรือเทาน้ำเงิน สีเข้มและสดใสเหมาะกับคุณที่สุด'
      },
      ...
      drapingMode: {
        title: 'โหมดผู้เชี่ยวชาญในการเลือกสี (Expert Draping Mode)',
        startCamera: 'เริ่มกล้อง',
        saveColor: 'บันทึกสีปัจจุบัน',
        faceGuide: 'จัดแนวใบหน้าของคุณ<br>ให้ตรงกับแนวทาง',
        seasonPalette: '4 Season Color Palette (กลุ่มสีตามฤดูกาลทั้ง 4)',
        spring: 'Spring (ฤดูใบไม้ผลิ)',
        summer: 'Summer (ฤดูร้อน)',
        autumn: 'Autumn (ฤดูใบไม้ร่วง)',
        winter: 'Winter (ฤดูหนาว)',
        description: 'ลองใช้สี Spring, Summer, Autumn และ Winter บนใบหน้าของคุณเพื่อค้นหากลุ่มสีตามฤดูกาลที่เหมาะกับคุณที่สุด',
        feature1: 'การทาบสีแบบเรียลไทม์ผ่านกล้อง',
        feature2: 'มี 4 season color palette (กลุ่มสีตามฤดูกาลทั้ง 4) ให้เลือก',
        feature3: 'เปรียบเทียบก่อน/หลังได้ทันที',
        feature4: 'คำแนะนำผลิตภัณฑ์เฉพาะแบรนด์',
        startBtn: 'เริ่มทาบสี',
        colorAdjust: 'ปรับสี',
        lightness: 'ความสว่าง',
        saturation: 'ความอิ่มสี',
        warmth: 'ความอบอุ่น',
        recommendProducts: 'ผลิตภัณฑ์สีผมที่แนะนำ',
        compareBtn: '🔀 โหมดเปรียบเทียบ',
        compareEnd: '❌ จบการเปรียบเทียบ',
        warmVsCool: '🔥 เปรียบเทียบโทนอุ่นกับโทนเย็น',
        leftBtn: '👈 ซ้าย',
        rightBtn: 'ขวา 👉',
        compareComplete: '🎉 เปรียบเทียบเสร็จสมบูรณ์!',
        closeBtn: 'ปิด',
        guideBtn: 'คู่มือ',
      ...
      toast: {
        returningHome: 'กลับสู่หน้าหลัก',
        aiModeActivated: 'เปิดใช้งานโหมดวิเคราะห์สีผิวส่วนบุคคลด้วย AI',
        drapingModeActivated: 'เปิดใช้งานโหมดทาบสีโดยผู้เชี่ยวชาญ',
        checkingPermission: 'กำลังตรวจสอบการอนุญาตใช้กล้อง...',
        cameraStarted: 'กล้องเริ่มทำงานแล้ว!',
        faceRecognitionEnabled: 'เปิดใช้งานการจดจำใบหน้า',
        basicCameraMode: 'เริ่มต้นในโหมดกล้องพื้นฐาน',
        aiCameraStopped: 'AI camera stopped (กล้อง AI หยุดทำงาน)',
        startCameraFirst: 'Please start camera first (กรุณาเปิดกล้องก่อน)',
        startingAiAnalysis: 'Starting AI analysis... (กำลังเริ่มการวิเคราะห์ด้วย AI...)',
        aiAnalysisComplete: 'AI analysis complete (การวิเคราะห์ด้วย AI เสร็จสมบูรณ์)',
        startingDrapingCamera: 'Starting draping camera... (กำลังเริ่มกล้องสำหรับทาบสี...)',
        drapingCameraStarted: 'Draping camera started (กล้องสำหรับทาบสีเริ่มทำงาน)',
        cameraAccessDenied: 'Cannot access camera (ไม่สามารถเข้าถึงกล้องได้)',
        drapingCameraStopped: 'Draping camera stopped (กล้องสำหรับทาบสีหยุดทำงาน)',
        seasonSelected: 'Season color selected (เลือกสีตามฤดูกาลแล้ว)',
        selectColorFirst: 'Please select a color first (กรุณาเลือกสี ก่อน)',
        colorSaved: 'Current color saved (บันทึกสีปัจจุบันแล้ว)',
        compareAgain: 'Compare Again (เปรียบเทียบอีกครั้ง)',
        savedColorsGuide: 'Saved Colors & Expert Guide (สีที่บันทึกไว้ & คำแนะนำจากผู้เชี่ยวชาญ)',
        webviewFaceLimit: 'Face recognition is limited in WebView. Please use Chrome browser. (การจดจำใบหน้ามีข้อจำกัดใน WebView โปรดใช้เบราว์เซอร์ Chrome)',
        webviewNoFace: 'Face recognition is not supported in WebView (ไม่รองรับการจดจำใบหน้าใน WebView)',
        compareModeStarted: 'เริ่มโหมดเปรียบเทียบแล้ว เลือกสีที่เหมาะกับคุณมากขึ้น!',
        selected: 'เลือกแล้ว!',
        compareResult: 'ผลการเปรียบเทียบ',
        compareRestart: 'กำลังเริ่มการเปรียบเทียบใหม่!'
      },

      cameraErrors: {
        permissionDeniedAndroid: 'ไม่อนุญาตการเข้าถึงกล้อง\n\nไปที่ การตั้งค่า > แอป > HAIRGATOR > การอนุญาต > กล้อง เพื่ออนุญาต',
        permissionDeniedIOS: 'ไม่อนุญาตการเข้าถึงกล้อง\n\nไปที่ การตั้งค่า > HAIRGATOR > กล้อง เพื่ออนุญาต',
        permissionDeniedBrowser: 'ไม่อนุญาตการเข้าถึงกล้อง\n\nโปรดอนุญาตการเข้าถึงกล้องในการตั้งค่าเบราว์เซอร์',
        notFound: 'ไม่พบกล้อง\n\nโปรดตรวจสอบว่าอุปกรณ์ของคุณมีกล้อง',
        inUse: 'กล้องกำลังถูกใช้งานโดยแอปอื่น\n\nปิดแอปอื่นและลองอีกครั้ง',
        notSupported: 'กล้องไม่รองรับในสภาพแวดล้อมนี้',
        overConstrained: 'ข้อผิดพลาดในการตั้งค่ากล้อง โปรดลองอีกครั้ง',
        securityError: 'ข้อผิดพลาดด้านความปลอดภัย\n\nกล้องสามารถใช้งานได้เฉพาะในสภาพแวดล้อม HTTPS เท่านั้น',
        generic: 'ไม่สามารถเข้าถึงกล้องได้'
      },
      ...
      undertones: {
        warm: 'Warm Tone (โทนสีอุ่น)',
        cool: 'Cool Tone (โทนสีเย็น)',
        neutral: 'Neutral Tone (โทนสีกลาง)'
      },

      seasons: {
        springWarmBright: 'Spring Warm Bright (โทนสีอบอุ่นแบบฤดูใบไม้ผลิ สดใส)',
        springWarmLight: 'Spring Warm Light (โทนสีอบอุ่นแบบฤดูใบไม้ผลิ อ่อน)',
        autumnWarmDeep: 'Autumn Warm Deep (โทนสีอบอุ่นแบบฤดูใบไม้ร่วง เข้ม)',
        autumnWarmMuted: 'Autumn Warm Muted (โทนสีอบอุ่นแบบฤดูใบไม้ร่วง หม่น)',
        summerCoolBright: 'Summer Cool Bright (โทนสีเย็นแบบฤดูร้อน สดใส)',
        summerCoolLight: 'Summer Cool Light (โทนสีเย็นแบบฤดูร้อน อ่อน)',
        winterCoolDeep: 'Winter Cool Deep (โทนสีเย็นแบบฤดูหนาว เข้ม)',
        winterCoolMuted: 'Winter Cool Muted (โทนสีเย็นแบบฤดูหนาว หม่น)',
        neutralLight: 'Neutral Light (สีกลาง อ่อน)',
        neutralDeep: 'Neutral Deep (สีกลาง เข้ม)'
      },

      seasonDescriptions: {
        springWarmBright: 'ภาพลักษณ์ที่สดใสและเปล่งประกาย! สีโทนอุ่นที่สดใสและสว่างเหมาะกับคุณที่สุด',
        springWarmLight: 'ภาพลักษณ์ที่ชัดเจนและบริสุทธิ์! สีโทนอุ่นที่นุ่มนวลและอ่อนโยนเหมาะกับคุณที่สุด',
        autumnWarmDeep: 'ภาพลักษณ์ที่ลุ่มลึกและหรูหรา! สีโทนอุ่นที่เข้มข้นและลึกซึ้งเหมาะกับคุณที่สุด',
        autumnWarmMuted: 'ภาพลักษณ์ที่เป็นธรรมชาติและซับซ้อน! สีโทนอุ่นที่สงบและเป็นธรรมชาติเหมาะกับคุณที่สุด',
        autumnWarmSoft: 'ภาพลักษณ์ที่นุ่มนวลและอบอุ่น! สีโทนอุ่นที่ละเอียดอ่อนและเป็นธรรมชาติเหมาะกับคุณที่สุด',
        summerCoolBright: 'ภาพลักษณ์ที่สดชื่นและเย็นสบาย! สีโทนเย็นที่สดใสและสะอาดเหมาะกับคุณที่สุด',
        summerCoolLight: 'ภาพลักษณ์ที่สง่างามและอ่อนโยน! สีโทนเย็นพาสเทลเหมาะกับคุณที่สุด',
        winterCoolDeep: 'ภาพลักษณ์ที่โดดเด่นและทันสมัย! สีโทนเย็นที่สดใสและเข้มข้นเหมาะกับคุณที่สุด',
        winterCoolMuted: 'ภาพลักษณ์ที่สงบและประณีต! สีโทนเย็นที่ไม่มีสีและมีความอิ่มตัวต่ำเหมาะกับคุณที่สุด',
        neutralLight: 'ประเภทที่หลากหลาย! แนะนำสีอ่อนและนุ่ม',
        neutralDeep: 'ประเภทที่หลากหลาย! แนะนำสีเข้มและซับซ้อน'
      },

      seasonRecommendations: {
        springWarmBright: '💄 สี: Vivid Coral, Orange Red, Bright Peach\n💎 โลหะ: Yellow Gold, Bright Gold',
        springWarmLight: '💄 สี: Apricot, Light Coral, Ivory, Cream\n💎 โลหะ: Rose Gold, Champagne Gold',
        autumnWarmDeep: '💄 สี: Burgundy, Chocolate Brown, Deep Terracotta\n💎 โลหะ: Antique Gold, Bronze',
        autumnWarmMuted: '💄 สี: Mustard, Olive, Khaki, Terracotta\n💎 โลหะ: Gold, Brass',
        autumnWarmSoft: '💄 สี: Camel, Salmon, Soft Coral, Mocha\n💎 โลหะ: Rose Gold, Antique Gold',
        summerCoolBright: '💄 สี: Rose Pink, Lavender, Sky Blue\n💎 โลหะ: White Gold, Rose Gold',
        summerCoolLight: '💄 สี: Soft Pink, Lilac, Powder Blue\n💎 โลหะ: Silver, White Gold',
        winterCoolDeep: '💄 สี: Wine, Royal Blue, Emerald, Black\n💎 โลหะ: Platinum, White Gold',
        winterCoolMuted: '💄 สี: Charcoal, Navy, Burgundy, Dark Gray\n💎 โลหะ: Silver, Gunmetal',
        neutralLight: '💄 สี: Dusty Pink, Soft Beige, Light Mauve\n💎 โลหะ: Rose Gold, Soft Silver',
        neutralDeep: '💄 สี: Taupe, Mauve, Dark Brown, Olive\n💎 โลหะ: Mixed Metals, Antique Silver'
      },
      ...
      // Color palette names
      colorNames: {
        tomato: 'มะเขือเทศ', coral: 'สีปะการัง', gold: 'สีทอง', turquoise: 'สีเทอร์ควอยซ์', hotPink: 'สีชมพูสด',
        peach: 'สีพีช', moccasin: 'สีมอคคาซิน', wheat: 'สีข้าวสาลี', mint: 'สีมิ้นท์', lightPink: 'สีชมพูอ่อน',
        saddleBrown: 'สีน้ำตาลอานม้า', sienna: 'สีเซียนนา', maroon: 'สีแดงเลือดหมู', olive: 'สีโอลีฟ', darkRed: 'สีแดงเข้ม',
        peru: 'สีเปรู', chocolate: 'สีช็อกโกแลต', khaki: 'สีกากี', rosyBrown: 'สีน้ำตาลอมชมพู',
        tan: 'สีแทน', tan2: 'สีแทน', burlywood: 'สีเบอร์ลีวูด', buff: 'สีบัฟ', cocoa: 'สีโกโก้',
        purple: 'สีม่วง', cyan: 'สีฟ้า', teal: 'สีเขียวเป็ด', orchid: 'สีม่วงกล้วยไม้',
        lavender: 'สีลาเวนเดอร์', thistle: 'สีธิสเซิล', powderBlue: 'สีฟ้าพาสเทล', paleTurquoise: 'สีฟ้าเทอร์ควอยซ์อ่อน',
        navy: 'สีน้ำเงินกรมท่า', darkMagenta: 'สีแดงม่วงเข้ม', darkGreen: 'สีเขียวเข้ม', magenta: 'สีชมพูม่วง', black: 'สีดำ',
        slate: 'สีชนวน', lightSlate: 'สีชนวนอ่อน', darkSlate: 'สีชนวนเข้ม', dimGray: 'สีเทาหม่น', steelBlue: 'สีน้ำเงินเหล็ก',
        plum: 'สีพลัม', cherryBlossom: 'สีดอกซากุระ', navajoWhite: 'Navajo White',
        royalBlue: 'Royal Blue', oliveDrab: 'Olive Drab', darkSlateBlue: 'Dark Slate Blue'
      },

      // Expert Guide UI
      expertGuide: {
        title: '👩‍🎨 คู่มือผู้เชี่ยวชาญด้านการออกแบบ',
        toneKeywords: '🎨 โทนสีและภาพลักษณ์',
        fashionVibe: '👗 สไตล์แฟชั่น',
        recommendLevel: '📊 ระดับที่แนะนำ',
        skinBrightness: '💡 คู่มือความสว่างของผิว',
        treatmentTips: '✂️ เคล็ดลับการดูแลเส้นผม',
        undercoat: 'Undercoat (สีชั้นใน)',
        texture: 'Finish Texture (ลักษณะพื้นผิวสุดท้าย)',
        totalBeautyTip: '💄 เคล็ดลับความงามครบวงจร',
        makeupBase: 'Makeup Base (เบสเมคอัพ)',
        consultingPoint: '💬 จุดให้คำปรึกษา',
        avoidTones: '⛔ โทนสีที่ควรหลีกเลี่ยง',
        brightSkin: 'คุณมีผิวสว่าง ระดับที่สูงขึ้นจะดูเป็นธรรมชาติ',
        mediumSkin: 'ความสว่างผิวปานกลาง ช่วงระดับที่แนะนำเหมาะกับคุณที่สุด',
        darkSkin: 'คุณมีผิวสีเข้ม ระดับที่สว่างมากอาจดูไม่เป็นธรรมชาติ'
      },

      // Treatment Difficulty
      difficulty: {
        easy: 'ง่าย',
        easyTip: 'สามารถใช้ได้โดยไม่ต้องฟอกสี',
        highLift: 'High Lift (การยกระดับสีสูง)',
        highLiftTip: 'สามารถปรับสีให้สว่างขึ้นได้ด้วยสี High Lift',
        toneUp: 'Tone Up Needed (ต้องการปรับสีให้สว่างขึ้น)',
        toneUpTip: 'แนะนำให้ใช้สีย้อม High lift (12-14Lv) หรือฟอกสี 1 ครั้ง',
        hard: 'ขั้นสูง',
        hardTip: 'ต้องฟอกสี 2 ครั้งขึ้นไป ระวังผมเสีย'
      },

      // Priority Badges
      priority: {
        bestMatch: 'Best Match (สีที่เข้ากันที่สุด)',
        levelOk: 'Level OK (ระดับสี OK)',
        toneOk: 'Tone OK (โทนสี OK)',
        good: 'ดี',
        option: 'Option (ตัวเลือก)'
      },

      toast: {
        ready: 'ระบบ Personal Color ของ HAIRGATOR พร้อมใช้งาน!',
        systemReady: 'ระบบพร้อมใช้งาน',
        systemReadyLimited: 'ระบบพร้อมใช้งาน (คุณสมบัติบางอย่างถูกจำกัด)',
        timeoutStart: 'เริ่มการทำงานโดยอัตโนมัติเนื่องจากหมดเวลา',
        errorMode: 'เกิดข้อผิดพลาด กำลังทำงานในโหมดพื้นฐาน',
        limitedFeatures: 'คุณสมบัติบางอย่างอาจถูกจำกัด',
        imageOnly: 'สามารถอัปโหลดได้เฉพาะไฟล์รูปภาพเท่านั้น',
        imageUploaded: 'อัปโหลดรูปภาพแล้ว เริ่มการวิเคราะห์!',
        analysisComplete: 'วิเคราะห์ประเภทเสร็จสมบูรณ์!',
        analysisError: 'เกิดข้อผิดพลาดระหว่างการวิเคราะห์',
        colorSaved: 'บันทึกสีแล้ว!',
        colorRemoved: 'ลบสีที่บันทึกแล้ว',
        cameraReady: 'กำลังเตรียมกล้อง...',
        cameraStarted: 'เริ่มการวิเคราะห์กล้องแบบเรียลไทม์!',
        cameraStopped: 'หยุดกล้องแล้ว',
        selectPhoto: 'เลือกรูปภาพเพื่อเริ่มการวิเคราะห์ AI!'
      },

      buttons: {
        startAnalysis: '🤖 เริ่มการวิเคราะห์ Personal Color ด้วย AI',
        analyzing: '🔄 กำลังวิเคราะห์...'
      },

      analysisSteps: {
        step1: 'กำลังตรวจจับพื้นที่ใบหน้า...',
        step2: 'กำลังดึงสีผิว...',
        step3: 'กำลังแปลงเป็นปริภูมิสี LAB...',
        step4: 'กำลังคำนวณค่า Delta E...',
        step5: 'กำลังวิเคราะห์ Personal Color...'
      },

      // Draping Guide
      drapingGuide: {
        title: 'คู่มือการวินิจฉัยสีแบบ 4 ฤดู (4-Season Draping Diagnosis Guide)',
        principleTitle: 'หลักการวินิจฉัยสีแบบ Draping',
        principleText: 'การวินิจฉัยสีแบบ Draping นั้นมีหลักการว่าช่วงความสว่าง/ความอิ่มสี/อุณหภูมิสีที่เหมาะสมจะแตกต่างกันไปตามระดับสีผิว (เม็ดสีผิวชั้นนอก vs ฮีโมโกลบินใต้ผิวหนัง)\n\nเมื่อสีผ้าเข้ากันกับสีผิว ผิวจะดูใส หากไม่เข้ากัน ผิวจะดูหมองหรือแดง',
        imageLabel: 'รูปภาพ:',
        attributeLabel: 'คุณสมบัติ:',
        spring: {
          title: 'Spring Warm (ฤดูใบไม้ผลิ โทนอุ่น)',
          image: 'อันเดอร์โทนสีเหลืองสดใสและอบอุ่น',
          attribute: 'ความสว่างสูง + ความอิ่มสีปานกลาง-สูง + โทนอุ่น (สีเหลือง)',
          best: 'สีปะการัง, สีพีช, สีงาช้าง, สีส้มสด',
          worst: 'สีชมพูอมเทา, สีเบอร์กันดี, สีกรมท่า'
        },
        summer: {
          title: 'Summer Cool (ฤดูร้อน โทนเย็น)',
          image: 'อันเดอร์โทนสีเทา/ชมพูอ่อนและเย็น',
          attribute: 'ความสว่างปานกลาง + ความอิ่มสีต่ำ-ปานกลาง + โทนเย็น (สีเทา-น้ำเงิน)',
          best: 'สีลาเวนเดอร์, สีชมพูกุหลาบ, สีฟ้า, สีขาวนวล',
          worst: 'สีส้ม, สีกากี, สีมัสตาร์ด'
        },
        autumn: {
          title: 'Autumn Warm (ฤดูใบไม้ร่วง โทนอุ่น)',
          image: 'อันเดอร์โทนสีน้ำตาลทองเข้มและเข้มข้น',
          attribute: 'ความสว่างต่ำ-ปานกลาง + ความอิ่มสีต่ำ-ปานกลาง + โทนอุ่น (สีทอง)',
          best: 'สีกากี, สีดินเผา, สีมัสตาร์ด, สีโอลีฟ',
          worst: 'สีชมพูอ่อน, สีฟ้าพาสเทล, สีแดงสด'
        },
        winter: {
          title: 'Winter Cool (ฤดูหนาว โทนเย็น)',
          image: 'อันเดอร์โทนสีน้ำเงินม่วงสดใสและเย็น',
          attribute: 'ความสว่างต่ำ/สูงมาก + ความอิ่มสีสูง + โทนเย็น (สีน้ำเงิน-ม่วง)',
          best: 'สีขาวบริสุทธิ์, สีดำ, สีน้ำเงิน Royal Blue, สีเบอร์กันดี, สีชมพู Hot Pink',
      ...
      personalAnalysis: {
        title: 'ข้อมูลลูกค้า',
        subtitle: 'โปรดป้อนข้อมูลพื้นฐานก่อนการวิเคราะห์ด้วย AI',
        step1Title: 'ความสูง & ความยาว',
        step2Title: 'สไตล์ที่ต้องการ',
        step3Title: 'สภาพผิว & ลอนผม',
        height: 'ส่วนสูง (ซม.)',
        currentLength: 'ความยาวปัจจุบัน',
        desiredLength: 'ความยาวที่ต้องการ',
        fringePreference: 'ต้องการผมหน้าม้า (Fringe Preference) หรือไม่',
        skinType: 'ประเภทผิว',
        curlPreference: 'ลักษณะลอนผม (Curl Preference)',
        next: 'ถัดไป',
        prev: 'ก่อนหน้า',
        complete: 'เสร็จสิ้น',
        selectHeight: 'โปรดเลือกส่วนสูงของคุณ',
        selectCurrentLength: 'โปรดเลือกความยาวปัจจุบันของคุณ',
        selectDesiredLength: 'โปรดเลือกความยาวที่ต้องการของคุณ',
        selectFringe: 'โปรดเลือกว่าต้องการผมหน้าม้า (Fringe Preference) หรือไม่',
        selectSkinType: 'โปรดเลือกประเภทผิวของคุณ',
        selectCurl: 'โปรดเลือกลักษณะลอนผมที่คุณต้องการ',
        inputComplete: 'ข้อมูลลูกค้าครบถ้วน! เริ่มการวิเคราะห์ด้วย AI',
        heightShort: 'สั้น',
        heightMedium: 'ปานกลาง',
        heightTall: 'สูง',
        lengthShort: 'สั้น',
        lengthMedium: 'ปานกลาง',
        lengthLong: 'ยาว',
        skinTP: 'TP (Transparent) (โปร่งแสง)',
        skinNP: 'NP (Neutral) (เป็นกลาง)',
        skinBP: 'BP (Base) (โทนสีหลัก)',
        curlStraight: 'ตรง',
        curlC: 'C-Curl (ลอนตัวซี)',
        curlS: 'S-Curl (ลอนตัวเอส)',
        curlCS: 'CS-Curl (ลอนตัวซีและเอส)',
        curlSS: 'SS-Curl (ลอนตัวเอสสองชั้น)',
        curlNone: 'ไม่ต้องการ',
        // Male style tones
        maleWarmLabel: 'รูปหน้าทรงกลม - เหมาะสำหรับใบหน้าเหลี่ยมหรือสี่เหลี่ยม',
        maleWarmReason: 'ไรผมโค้งมนและเส้นโค้งที่อ่อนโยนช่วยลดความแข็งกระด้างของกราม ทำให้ดูอ่อนโยนและเป็นมิตรยิ่งขึ้น',
        maleNeutralLabel: 'รูปหน้าทรงสี่เหลี่ยม - เหมาะสำหรับใบหน้ากลมหรือรูปไข่',
        maleNeutralReason: 'รูปทรงสี่เหลี่ยมช่วยเพิ่มมุมให้กับใบหน้ากลม ทำให้ใบหน้าดูคมชัดและมีความเป็นชายมากขึ้น',
        maleCoolLabel: 'รูปหน้าทรงสามเหลี่ยม - เหมาะสำหรับใบหน้าสั้นหรือกว้าง',
        maleCoolReason: 'วอลลุ่มด้านบนและมุมที่คมชัดดึงดูดสายตาขึ้นด้านบน ทำให้ใบหน้าดูยาวและเรียวขึ้น',
        fringeForehead: 'แนวหน้าผาก',
        fringeEyebrow: 'แนวคิ้ว',
        fringeEye: 'แนวสายตา',
        fringeCheekbone: 'แนวโหนกแก้ม',
        fringeLips: 'แนวริมฝีปาก',
        fringeNone: 'ไม่มี',
        faceAnalysis: 'วิเคราะห์รูปหน้า',
        narrowGap: 'ช่องว่างแคบ',
        balancedGap: 'ช่องว่างสมดุล',
        wideGap: 'ช่องว่างกว้าง',
        faceRatio: 'สัดส่วนใบหน้า',
        eyeDistance: 'ระยะห่างระหว่างดวงตา',
        // Additional keys (for HTML)
        gender: 'เพศ',
        step1Desc: 'เลือกเพศและความสูงของคุณเพื่อรับคำแนะนำเกี่ยวกับสไตล์ที่เหมาะสมกับรูปร่างของคุณ',
        step2Desc: 'เลือกระดับความยาวและผมหน้าม้าที่ต้องการเพื่อวิเคราะห์ความเข้ากันได้ของรูปร่าง',
        step3Desc: 'ประเภทผิวและความชอบลอนผมจะถูกเปรียบเทียบกับการวิเคราะห์สีผิวส่วนบุคคลของ AI เพื่อปรับปรุงความแม่นยำในการจับคู่สีและคำแนะนำสีผม',
        maleStep2Desc: 'เลือกทรงผมที่คุณต้องการเพื่อรับคำแนะนำสีที่เข้ากับรูปร่างและสีผิวของคุณ',
        skinTypeDesc: 'ตรวจสอบสีของเส้นเลือดภายในข้อมือและลักษณะผิว',
        skinTPTitle: 'ผิวโปร่งแสง (โทนเย็น)',
        skinTPDesc: '<div style="margin-bottom: 4px;">✓ <b>สีเส้นเลือด:</b> โทนน้ำเงิน/ม่วง</div><div style="margin-bottom: 4px;">✓ <b>ลักษณะผิว:</b> ผิวบาง โปร่งแสง เห็นเส้นเลือด</div><div>✓ <b>สีที่เหมาะ:</b> เครื่องประดับเงิน โทนชมพู/น้ำเงิน</div>',
        skinNPTitle: 'ผิวเป็นกลาง',
        skinNPDesc: '<div style="margin-bottom: 4px;">✓ <b>สีเส้นเลือด:</b> ผสมเขียว/น้ำเงิน-เขียว</div><div style="margin-bottom: 4px;">✓ <b>ลักษณะผิว:</b> โทนโอลีฟหรือเบจ ไม่ชัดว่าเย็น/อุ่น</div><div>✓ <b>สีที่เหมาะ:</b> ทั้งทองและเงิน สีหลากหลาย</div>',
        skinBPTitle: 'ผิวโทนสีหลัก (โทนอุ่น)',
        skinBPDesc: '<div style="margin-bottom: 4px;">✓ <b>สีเส้นเลือด:</b> โทนเขียว/เหลือง-เขียว</div><div style="margin-bottom: 4px;">✓ <b>ลักษณะผิว:</b> อันเดอร์โทนสีเหลือง ผิวหนา</div><div>✓ <b>สีที่เหมาะ:</b> เครื่องประดับทอง โทนส้ม/น้ำตาล</div>',
        // Length options (H~A)
        lengthH: 'สั้น',
        lengthG: 'เหนือคาง',
        lengthF: 'ใต้คาง',
        lengthE: 'เหนือไหล่',
        lengthD: 'ระดับไหล่',
        lengthC: 'ต่ำกว่ากระดูกไหปลาร้า',
        lengthB: 'ระดับอก',
        lengthA: 'ระดับเอว',
        // Result panel labels
        manualInput: 'ป้อนข้อมูลเอง',
        aiAnalysis: 'วิเคราะห์โดย AI',
        integratedAnalysis: 'วิเคราะห์แบบบูรณาการ',
        labelHeight: 'ความสูง',
        labelCurrentDesired: 'ปัจจุบัน→ที่ต้องการ',
        labelFringe: 'Fringe (ผมหน้าม้า)',
        labelSkinType: 'ประเภทผิว',
        labelCurl: 'Curl (ผมลอน)',
        labelSkinTone: 'สีผิว',
        labelUndertone: 'Undertone (โทนสีผิว)',
        labelSeason: 'ฤดูกาล',
        designerAiMatch: 'จับคู่โดยดีไซเนอร์ + AI → ความมั่นใจสูง',
        designerAiCombined: 'การวิเคราะห์แบบผสมผสาน',
        lengthFit: 'ความเหมาะสมกับรูปร่าง',
        lengthRecommend: 'แนะนำ',
        stepsLonger: 'ยาวขึ้นอีก ... ขั้นตอน',
        stepsShorter: 'สั้นลงอีก ... ขั้นตอน',
        maintain: 'คงเดิม',
        difficultyEasy: 'ง่าย',
        difficultyMedium: 'ปานกลาง',
        difficultyHard: 'ยาก',
        integratedResult: 'ผลการวิเคราะห์ส่วนบุคคล',
        customerProfile: 'ข้อมูลลูกค้า',
        desiredLength: 'ความยาวที่ต้องการ',
        selected: 'ที่เลือก',
        // Male side treatment
        maleSideLabel: '🔹 การดูแลด้านข้าง (ขมับ)',
        maleSideDesc: 'เลือกวิธีการตัดแต่งด้านข้างและด้านหลัง',
        fadeTitle: 'Fade (เฟด)',
        fadeDesc: 'ไล่ระดับจากสั้นไปยาวอย่างค่อยเป็นค่อยไป ดูมีสไตล์',
        underTitle: 'Undercut (อันเดอร์คัต)',
        underDesc: 'ตัดสั้นด้านข้างเพื่อความแตกต่าง ดูสะอาดตา',
        naturalSideTitle: 'Natural (ธรรมชาติ)',
        naturalSideDesc: 'ความยาวสม่ำเสมอโดยรวม ตัดด้วยกรรไกรอย่างเป็นธรรมชาติ',
        // Male fringe direction
        maleFrontLabel: '🔹 ทิศทางการจัดแต่งทรงผมหน้าม้า',
        maleFrontDesc: 'เลือกวิธีการจัดแต่งทรงผมหน้าม้าของคุณ',
        allBackTitle: 'All Back (เสยไปด้านหลังทั้งหมด)',
        allBackDesc: 'เสยผมหน้าม้าไปด้านหลัง',
        sidePartTitle: 'Side Part (แสกข้าง)',
        sidePartDesc: 'แสกข้าง 7:3',
        centerDownTitle: 'Center Down (ลงตรงกลาง)',
        centerDownDesc: 'ลงมาบริเวณหน้าผาก',
        seeThroughTitle: 'See-through (ซีทรู)',
        seeThroughDesc: 'ผมหน้าม้าบางเบา',
        // Male styles (Step 2)
        buzzTitle: 'Buzz Cut (บัตซ์คัต)',
        buzzDesc: 'ตัดสั้นเกรียนทั้งหมด',
        cropTitle: 'Crop Cut',
        cropDesc: 'หน้าม้าสั้น + เฟด (Fade)',
        fringeUpTitle: 'Fringe Up (หน้าม้าตั้งขึ้น)',
        fringeUpDesc: 'Fringe (หน้าม้า) จัดทรงขึ้น, ทรง Ivy League',
        sideFringeTitle: 'Side Fringe (หน้าม้าปัดข้าง)',
        sideFringeDesc: 'Fringe (หน้าม้า) ปัดไปด้านข้าง',
        sidePartStyleTitle: 'Side Part (แสกข้าง)',
        sidePartStyleDesc: 'แสกไปด้านใดด้านหนึ่ง',
        pushedBackTitle: 'Pushed Back (เสยไปด้านหลัง)',
        pushedBackDesc: 'เสยไปด้านหลังทั้งหมด',
        mohicanTitle: 'Mohican (โมฮิกัน)',
        mohicanDesc: 'Volume on crown (ผมด้านบนศีรษะ)',
        // Validation messages
        selectGender: 'กรุณาเลือกเพศ',
        selectMaleStyle: 'กรุณาเลือกทรงผม',
        selectSide: 'กรุณาเลือกการจัดการด้านข้าง',
        selectFront: 'กรุณาเลือกทิศทางหน้าม้า',
        inputComplete: 'ข้อมูลลูกค้าครบถ้วน! เริ่มการวิเคราะห์ด้วย AI'
      },
      titleShort: 'ความคืบหน้าการวิเคราะห์ AI',
      narrowGapDesc: 'ระยะห่างแคบ - ดวงตาดูใกล้กัน',
      wideGapDesc: 'ระยะห่างกว้าง - ดวงตาดูห่างกัน',
      balancedGapDesc: 'ระยะห่างสมดุล - สัดส่วนที่เหมาะสม',
    },

    // ========== Mobile Notice ==========
    mobileNotice: {
      title: 'HAIRGATOR เหมาะสำหรับแท็บเล็ต',
      desc: 'เพื่อประสบการณ์ที่ดีกว่า กรุณาใช้แท็บเล็ต',
      downloadBtn: 'ดาวน์โหลดแอปบนแท็บเล็ต',
      continueBtn: 'ดำเนินการต่อ',
      downloadAlert: 'โปรดค้นหา HAIRGATOR บนแท็บเล็ตของคุณเพื่อดาวน์โหลด'
    },

    // ========== Terms Agreement ==========
    terms: {
      title: 'ข้อตกลงการใช้บริการ',
      subtitle: '<span class="warning-icon">!</span> ประกาศเกี่ยวกับลิขสิทธิ์และทรัพย์สินทางปัญญา',
      content1: 'เนื้อหาทั้งหมดที่ HAIRGATOR จัดหาให้ รวมถึงรูปภาพ กราฟิก ข้อความ และวิดีโอ เป็นทรัพย์สินของ <strong>AIW Inc.</strong> และได้รับการคุ้มครองโดยกฎหมายลิขสิทธิ์ (รวมถึงการจดทะเบียนซอฟต์แวร์) สิทธิบัตร และเครื่องหมายการค้า',
      content2: 'การคัดลอก แจกจ่าย ขาย แสดง หรือแก้ไขเนื้อหา HAIRGATOR โดยไม่ได้รับอนุญาตเพื่อบริการที่คล้ายคลึงกัน อาจส่งผลให้เกิด <strong>ความรับผิดทางแพ่งและอาญา</strong>',
      agreeBtn: 'ยอมรับและดำเนินการต่อ'
    },

    // ========== Payment/Plans ==========
    payment: {
      upgrade: 'คู่มือราคา',
      unlockAll: 'ปลดล็อกคุณสมบัติทั้งหมด',
      choosePlan: 'คู่มือราคา',
      current: 'ปัจจุบัน',
      addonNotice: 'ผลิตภัณฑ์นี้สามารถซื้อได้จากแท็บผลิตภัณฑ์เท่านั้น',
      selectPlanTitle: 'เลือกแผน',
      unlockPremium: 'ปลดล็อกคุณสมบัติพิเศษ',
      currentPlan: 'ปัจจุบัน',
      freePlan: 'ฟรี',
      freeTokenInfo: 'โทเค็นฟรีสามารถใช้ได้กับแชทบอทเท่านั้น',
      basicPlan: 'Basic',
      proPlan: 'Pro',
      businessPlan: 'Business',
      plan: 'แผน',
      ...
      efficiency4: 'คุ้มค่ากว่า 4% ต่อการชนะ',
      efficiency11: 'คุ้มค่ากว่า 11% ต่อการชนะ',
      savePercent: '+700 โทเค็นโบนัส',
      savePercentBiz: '+2,250 โทเค็นโบนัส',
      selectPlan: 'เลือกแผน',
      currentPlanBtn: 'แผนปัจจุบัน',
      note: '* เครดิตจะรีเซ็ตทุกเดือน เครดิตที่ไม่ได้ใช้จะไม่ทบไปเดือนถัดไป',
      feature: {
        styleMenu: 'เมนูทรงผม',
        styleMatch: 'AI Style Matching (จับคู่สไตล์ด้วย AI)',
        personalColor: 'Personal Color Analysis (วิเคราะห์สีที่เหมาะกับคุณ)',
        drapeMode: 'Drape Mode',
        chatbotLimited: 'Chatbot (ใช้ Tokens)',
        chatbot: 'Chatbot',
        lookbook: 'Lookbook',
        hairTry: 'Hair Try-On (ลองทรงผม)',
        allFree: 'คุณสมบัติฟรีทั้งหมด',
        allBasic: 'คุณสมบัติพื้นฐานทั้งหมด',
        moreCredits: 'เครดิตเพิ่มขึ้น 80%',
        maxCredits: 'เครดิตเพิ่มขึ้น 150%',
        betterValue: 'คุ้มค่ากว่าต่อดอลลาร์',
        bestValue: 'แผนที่คุ้มค่าที่สุด',
        faceSwap: 'AI Face Swap (สลับใบหน้าด้วย AI)',
        clothingChange: 'Clothing/Background Change (เปลี่ยนเสื้อผ้า/พื้นหลัง)'
      },
      faceSwapPlan: 'AI Face Transform (แปลงใบหน้าด้วย AI)',
      times: 'ครั้ง',
      addonNote: 'ผลิตภัณฑ์นี้สามารถซื้อได้จากแท็บผลิตภัณฑ์เท่านั้น',
      payAtProductTab: 'โปรดชำระเงินจากแท็บผลิตภัณฑ์',
      freePlanRestricted: 'มีให้ใช้ในแผนชำระเงิน',
      freeUsage: 'ใช้งาน Chatbot ได้ประมาณ 20 ครั้ง',
      basicUsage: '50 Lookbook หรือ 28 Hair Try (ลองทรงผม)',
      proUsage: '90 Lookbook หรือ 51 Hair Try (ลองทรงผม)',
      businessUsage: '125 Lookbook หรือ 71 Hair Try (ลองทรงผม)'
    }
  },
};
...
console.log('🌍 HAIRGATOR 다국어 시스템 로드 완료 (8개 언어 지원)');
