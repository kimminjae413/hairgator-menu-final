...
const HAIRGATOR_I18N = {
  ...
  en: {
    ...
    styleMatch: {
      ...
      cameraHint: 'Align your face within the guide',
  ...
  vi: {
    ...
    styleMatch: {
      ...
      cameraHint: 'Căn chỉnh khuôn mặt trong khung hướng dẫn',
