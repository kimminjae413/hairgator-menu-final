...
const HAIRGATOR_I18N = {
  ko: {
    ...
    aiStudio: {
      ...
      canvasTitle: '솔루션 캔버스',
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b>는<br>커트/펌 레시피와 헤어 이론에 특화된 AI입니다.<br><br>💡 <b>이렇게 활용해보세요!</b><br><br><b>1) 스타일 이미지 업로드</b><br>배우고 싶은 스타일을 업로드하고 레시피로 연습하세요.<br><span style="color:#888">예: 허쉬컷 사진 업로드 → 맞춤 레시피 확인</span><br><br><b>2) 이론/원리 질문</b><br>궁금했던 내용을 질문해 이해도를 높이세요.<br><span style="color:#888">예: "복구펌 원리가 뭐야?", "손상모에 어떤 샴푸?"</span><br><br>고객 질문에 과학적 근거로 답변하는 연습을 해두면<br>당신에 대한 고객의 신뢰도가 높아질 거예요.',
      backToMenu: '메뉴로 돌아가기',
      newChat: '새 채팅',
      history: '히스토리',
      deleteChat: '대화 삭제',
  ...
  ja: {
    ...
    aiStudio: {
      ...
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b>は<br>カット/パーマレシピとヘア理論に特化したAIです。<br><br>💡 <b>こう活用しましょう！</b><br><br><b>1) スタイル画像アップロード</b><br>学びたいスタイルをアップロードしてレシピで練習。<br><span style="color:#888">例: ハッシュカット写真 → カスタムレシピ確認</span><br><br><b>2) 理論/原理を質問</b><br>気になる内容を質問して理解を深めましょう。<br><span style="color:#888">例:「復元パーマの原理は？」「ダメージヘアにどんなシャンプー？」</span><br><br>お客様の質問に科学的根拠で答える練習をしておくと<br>あなたへの信頼度が高まります。',
      backToMenu: 'メニューに戻る',
      newChat: '新しいチャット',
      history: '履歴',
      deleteChat: 'チャット削除',
  ...
  zh: {
    ...
    aiStudio: {
      ...
      canvasTitle: '解决方案画布',
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b>是<br>专注于剪发/烫发配方和头发理论的AI。<br><br>💡 <b>这样活用吧！</b><br><br><b>1) 上传风格图片</b><br>上传想学的风格，用配方练习。<br><span style="color:#888">例: 上传赫希剪照片 → 获取定制配方</span><br><br><b>2) 询问理论/原理</b><br>提问来加深理解。<br><span style="color:#888">例:"修复烫的原理是什么？""受损发质用什么洗发水？"</span><br><br>练习用科学依据回答顾客问题，<br>会提高顾客对你的信任度。',
      backToMenu: '返回菜单',
      newChat: '新对话',
      history: '历史',
      deleteChat: '删除对话',
  ...
  vi: {
    ...
    aiStudio: {
      ...
      canvasEmpty: '<b>HAIRGATOR AI STUDIO</b> là<br>AI chuyên về công thức cắt/uốn và lý thuyết tóc.<br><br>💡 <b>Hãy sử dụng như thế này!</b><br><br><b>1) Tải ảnh kiểu tóc</b><br>Tải kiểu muốn học và luyện tập với công thức.<br><span style="color:#888">VD: Tải ảnh hush cut → Nhận công thức tùy chỉnh</span><br><br><b>2) Hỏi lý thuyết/nguyên lý</b><br>Đặt câu hỏi để hiểu sâu hơn.<br><span style="color:#888">VD: "Nguyên lý uốn phục hồi?", "Dầu gội nào cho tóc hư?"</span><br><br>Luyện tập trả lời khách hàng bằng căn cứ khoa học—<br>sẽ nâng cao sự tin tưởng của họ với bạn.',
